/*! AgoraRTC|BUILD v3.0.0-0-g747f321 */ ! function (e, t) {
    ...
    return function (e) {
                    ...
                    if (n[0] = (e = new Date).toTimeString().split(" ")[0] + ":" + e.getMilliseconds() + " Agora-SDK [" + (v[t] || "DEFAULT") + "]:", function (e, t) {
                            if (Object(o.getParameter)("UPLOAD_LOG")) try {
                                ...
                                t.forEach(function (e) {
                                    ...
                                    payload: n,
                                    log_level: e
                                }), "free" === d && (l = u.length < 10 ? u.splice(0, u.length) : u.splice(0, 10), S(l))
                            } catch (e) {}
                        }(t, n), !(t < h)) switch (t) {
                        case 0:
                        case 1:
        ...
        var i = n(8),
            ...
            s = function (e, t, n, i, a) {
                if (y(n) && (n = 1), i = i || 255, y(a) && (a = !0), y(e)) throw new Error("".concat(t || "param", " cannot be empty"));
            ...
            c = function (e, t, n, i) {
                if (y(n) && (n = 1), i = i || 1e4, y(e)) throw new Error("".concat(t || "param", " cannot be empty"));
            ...
            d = function (e, t, n, i) {
                ...
                if (y(n) && (n = 0), i = i || 1e4, y(e)) throw new Error("".concat(t || "param", " cannot be empty"));
                if (!f(e, n, i)) throw new Error("Invalid ".concat(t || "number param", ": The value range is [").concat(n, ",").concat(i, "]."))
            },
            u = function (e, t) {
                if (y(e)) throw new Error("".concat(t || "param", " cannot be empty"));
                if (!m(e)) throw new Error("Invalid ".concat(t || "boolean param", ": The value is of the boolean type."))
            },
            l = function (e, t, n, i) {
                return t || (t = 0), n || (n = Number.MAX_SAFE_INTEGER), y(i) && (i = !0), E(e) && (!i || h(e)) && e.length >= t && e.length <= n
            },
            p = function (e, t, n) {
                return S(e) && e >= t && e <= n
            },
        ...
        var p = {
            ...
            g = function () {
                ...
                return e.reportApiInvoke = function (e, n) {
                    ...
                    return function (e, t) {
                        if (clearTimeout(I), ++h > 1 && (e = "EXECUTOR_INVOKE_".concat(h)), e) return g._sendApiInvoke(a()({}, _(), {
                            success: !1,
                            error: e
                        }, o && {
                            states: o()
                        })), E && c.default.info("".concat(r, " onFailure"), e), p && p(e);
                        g._sendApiInvoke(a()({}, _(), {
                            success: !0
                        }, m && {
                            result: t
                            ...
                            states: o()
                        })), E && c.default.info("".concat(r, " onSuccess")), p && p(null, t)
                    }
                    ...
                    return i._state = _.RELAY_STATE_IDLE, i._onStatus = function (e) {
                        ...
                        return r(i, void 0, void 0, function () {
                            ...
                            return o(this, function (t) {
                                switch (t.label) {
                                    case 0:
                                        if (u.default.debug("[" + this.clientId + "] ChannelMediaSocket onClose"), this.emit("event", S.NETWORK_DISCONNECTED), this.state = _.RELAY_STATE_IDLE, !this._prevChannelMediaConfig) return [3, 4];
                                        t.label = 1;
                                    case 1:
                                    ...
                                    case 2:
                                        return t.sent(), [3, 4];
                                    case 3:
                                        return (e = t.sent()) instanceof y && (e.message === v.WS_ABORT || e.message === v.AP_REQUEST_ABORT) ? [2] : (this.emit("state", _.RELAY_STATE_FAILURE, E.SERVER_CONNECTION_LOST), [3, 4]);
                                    case 4:
                                        return [2]
                                }
                            })
                ...
                return a(t, e), Object.defineProperty(t.prototype, "state", {
                    ...
                    return r(this, void 0, void 0, function () {
                        return o(this, function (t) {
                            switch (t.label) {
                                case 0:
                                    if (this.state !== _.RELAY_STATE_IDLE) throw new y(v.BAD_STATE);
                    ...
                    return r(this, void 0, void 0, function () {
                        return o(this, function (t) {
                            switch (t.label) {
                                case 0:
                                    if (this.state !== _.RELAY_STATE_RUNNING) throw new y(v.BAD_STATE);
                    ...
                    return new Promise(function (n, i) {
                        var a = {
                            ...
                            o = "https://" + e;
                        l.post(o, r, function (e) {
                            var t = null,
                                a = null;
                            try {
                                t = JSON.parse(e)
                            } catch (e) {
                                i(new y(v.AP_JSON_PARSE_ERROR, e))
                            }
                            0 !== t.code && i(new y(v.AP_REQUEST_ERROR, t));
                            try {
                                a = JSON.parse(t.json_body)
                            } catch (e) {
                                i(new y(v.AP_JSON_PARSE_ERROR, e))
                            }
                            200 !== a.code && i(new y(v.AP_REQUEST_ERROR, a)), a.servers ? n(a.servers) : i(new y(v.AP_JSON_PARSE_ERROR, a))
                        }, function (e) {
                            return i(e)
                        }, {
                    ...
                    return new Promise(function (n, i) {
                        setTimeout(function () {
                            i(new y(v.AP_REQUEST_TIMEOUT))
                        }, 3e3), e.on("dispose", function () {
                            i(new y(v.AP_REQUEST_ABORT))
                    ...
                    return r(this, void 0, void 0, function () {
                        ...
                        return o(this, function (t) {
                            switch (t.label) {
                                ...
                                case 2:
                                    return t.sent(), this._signal.on("close", this._onClose.bind(this)), this._signal.on("status", this._onStatus.bind(this)), this.emit("event", S.NETWORK_CONNECTED), [2]
                            }
                        })
                    })
                    ...
                    return r(this, void 0, void 0, function () {
                        ...
                        return o(this, function (o) {
                            switch (o.label) {
                                case 0:
                                    return this._checkSignal(), t = this._genMessage(h.StopPacketTransfer), [4, this._signal.request(t)];
                                case 1:
                                    return o.sent(), [4, this._signal.waitStatus("Normal Quit")];
                                case 2:
                                    return o.sent(), u.default.debug("[" + this.clientId + "] startChannelMediaRelay: StopPacketTransfer success"), n = this._genMessage(h.SetSdkProfile, e), [4, this._signal.request(n)];
                                case 3:
                                    return o.sent(), u.default.debug("[" + this.clientId + "] startChannelMediaRelay: SetSdkProfile success"), i = this._genMessage(h.SetSourceChannel, e), [4, this._signal.request(i)];
                                case 4:
                                    return o.sent(), [4, this._signal.waitStatus("SetSourceChannelStatus")];
                                case 5:
                                    return o.sent(), this.emit("event", S.PACKET_JOINED_SRC_CHANNEL), u.default.debug("[" + this.clientId + "] startChannelMediaRelay: SetSourceChannel success"), a = this._genMessage(h.SetSourceUserId, e), [4, this._signal.request(a)];
                                case 6:
                                    return o.sent(), u.default.debug("[" + this.clientId + "] startChannelMediaRelay: SetSourceUserId success"), r = this._genMessage(h.SetDestChannel, e), [4, this._signal.request(r)];
                                case 7:
                                    return o.sent(), [4, this._signal.waitStatus("SetDestChannelStatus")];
                                case 8:
                                    return o.sent(), this.emit("event", S.PACKET_JOINED_DEST_CHANNEL), u.default.debug("[" + this.clientId + "] startChannelMediaRelay: SetDestChannel success"), s = this._genMessage(h.StartPacketTransfer, e), [4, this._signal.request(s)];
                                case 9:
                                    return o.sent(), this.emit("event", S.PACKET_SENT_TO_DEST_CHANNEL), this.state = _.RELAY_STATE_RUNNING, u.default.debug("[" + this.clientId + "] startChannelMediaRelay: StartPacketTransfer success"), [2]
                            }
                        })
                    })
                    ...
                    return r(this, void 0, void 0, function () {
                        ...
                        return o(this, function (n) {
                            switch (n.label) {
                                case 0:
                                    return this._checkSignal(), t = this._genMessage(h.Reconnect, e), [4, this._signal.request(t)];
                                case 1:
                                    return n.sent(), [2]
                            }
                        })
                    ...
                    return r(this, void 0, void 0, function () {
                        ...
                        return o(this, function (n) {
                            switch (n.label) {
                                case 0:
                                    return this._checkSignal(), t = this._genMessage(h.UpdateDestChannel, e), [4, this._signal.request(t)];
                                case 1:
                                    return n.sent(), this.emit("event", S.PACKET_UPDATE_DEST_CHANNEL), u.default.debug("[" + this.clientId + "] sendUpdateMessage: UpdateDestChannel success"), [2]
                            }
                        })
                    })
                    ...
                    return r(this, void 0, void 0, function () {
                        ...
                        return o(this, function (t) {
                            switch (t.label) {
                                case 0:
                                    return this._checkSignal(), e = this._genMessage(h.StopPacketTransfer), [4, this._signal.request(e)];
                                case 1:
                    ...
                    var n = this,
                        ...
                        s = null;
                    switch (e) {
                        case h.SetSdkProfile:
                            return o.clientRequest = {
                                command: "SetSdkProfile",
                                type: "multi_channel"
                            }, o;
                        case h.SetSourceChannel:
                        ...
                        case h.SetSourceUserId:
                            return s = t.getSrcChannelMediaInfo(), o.clientRequest = {
                                command: "SetSourceUserId",
                                uid: this.uid + ""
                            }, o;
                        case h.SetDestChannel:
                        ...
                        case h.StopPacketTransfer:
                            return o.clientRequest = {
                                command: "StopPacketTransfer"
                            }, o;
                        case h.UpdateDestChannel:
                            return t.getDestChannelMediaInfos().forEach(function (e) {
                                i.push(e.channelName), a.push(e.uid + ""), r.push(e.token || n.appId)
                            }), o.clientRequest = {
                    ...
                    if (!this._signal || !this._signal.isConnect()) throw new y(v.WS_DISCONNECTED)
                }, t
            }(c.default);
        t.default = m;
        var g = function () {
            ...
            return e.prototype.setSrcChannelInfo = function (e) {
                p.checkValidObject(e, "srcInfo");
                var t = e.uid,
                    n = e.channelName,
                    i = e.token;
                if (i && !p.isValidToken(i)) throw "Invalid token in SrcChannelInfo";
                if (!p.isValidChannelName(n)) throw "Invalid channelName in SrcChannelInfo";
                if (!f.is32Uint(t)) throw "Invalid uid in SrcChannelInfo";
                this.srcChannelMediaInfo = e
            }, e.prototype.setDestChannelInfo = function (e, t) {
                if (!p.isValidChannelName(e)) throw "Invalid channelName in DestChannelInfo";
                p.checkValidObject(t, "destInfo");
                var n = t.uid,
                    i = t.token,
                    a = t.channelName;
                if (i && !p.isValidToken(i)) throw "Invalid token in DestChannelInfo";
                if (!p.isValidChannelName(a)) throw "Invalid channelName in DestChannelInfo";
                if (!f.is32Uint(n)) throw "Invalid uid in DestChannelInfo";
                this.destChannelMediaInfos.set(e, t)
            }, e.prototype.removeDestChannelInfo = function (e) {
                if (!p.isValidChannelName(e)) throw "Invalid channelName when invoke removeDestChannelInfo";
        ...
        var v, h, S, _, E, I = function (e) {
                ...
                return a(t, e), t.prototype.isConnect = function () {
                    ...
                    if (!this._ws || this._ws.readyState !== WebSocket.OPEN) throw new y(v.WS_DISCONNECTED);
                    ...
                    return new Promise(function (n, i) {
                        var a = window.setTimeout(function () {
                            i(new y(v.WAIT_STATUS_TIMEOUT, e))
                        }, 5e3);
                        t.once(e, function (t) {
                            clearTimeout(a), t.state && 0 !== t.state ? i(new y(v.WAIT_STATUS_ERROR, e)) : n()
                        }), t.once("dispose", function () {
                            clearTimeout(a), i(new y(v.WS_ABORT))
                        })
                    })
                    ...
                    return new Promise(function (n, i) {
                        var a = t.sendMessage(e),
                            r = window.setTimeout(function () {
                                t.removeAllListeners("req_" + a), i(new y(v.REQUEST_TIMEOUT))
                            }, 3e3);
                        t.once("req_" + a, function (e) {
                            clearTimeout(r), e && 200 === e.code ? n(e) : i(new y(v.REQUEST_FAILED, e))
                        }), t.once("dispose", function () {
                            clearTimeout(r), i(new y(v.WS_ABORT))
                        })
                    })
                    ...
                    return new Promise(function (n, i) {
                        t._ws = new WebSocket(e), t._ws.onopen = function () {
                            ...
                            t._ws = null, i(new y(v.CONNECT_FAILED, "websocket error code: " + e.code))
                        }, setTimeout(function () {
                            t._ws && t._ws.readyState !== WebSocket.OPEN && (t._ws.onopen = null, t._ws.onclose = null, t._ws.close(), t._ws = null, i(new y(v.CONNECT_TIMEOUT)))
        ...
        t.ChannelMediaError = y,
            ...
            }(S = t.CHANNEL_MEDIA_RELAY_EVENT || (t.CHANNEL_MEDIA_RELAY_EVENT = {})),
            function (e) {
        ...
        var m = function (e, t, n) {
            ...
            v = function (e) {
                ...
                for (var n in e)
                    if ("lowLatency" === n && "boolean" != typeof e[n] || "userConfigExtraInfo" === n && "object" !== a()(e[n]) || "transcodingUsers" === n && !h(e[n]) || !~t.indexOf(n) && "number" != typeof e[n]) throw new Error("Param [" + n + "] is inValid");
                return !0
            },
            h = function (e) {
                for (var t = 0; t < e.length; t++)
        ...
        if ("object" == ("undefined" == typeof window ? "undefined" : a()(window)) ? (!window.HTMLMediaElement || "srcObject" in window.HTMLMediaElement.prototype ? (f = function (e, t) {
            ...
            if (navigator.mozGetUserMedia && window.mozRTCPeerConnection) {
                for (var S in h.log("This appears to be Firefox"), d = "firefox", u = h.extractVersion(navigator.userAgent, /Firefox\/([0-9]+)\./, 1), l = 31, g = mozRTCPeerConnection, v) v[S] = g.prototype[S];
                if (p = function (e, t) {
                        ...
                        return u < 38 && (h.log("spec: " + JSON.stringify(e)), e.audio && (e.audio = i(e.audio)), e.video && (e.video = i(e.video)), h.log("ff37: " + JSON.stringify(e))), navigator.mozGetUserMedia(e, t, n)
            ...
            for (var S in h.log("This appears to be Chrome"), d = "chrome", u = h.extractVersion(navigator.userAgent, /Chrom(e|ium)\/([0-9]+)\./, 2), l = 38, g = webkitRTCPeerConnection, v) v[S] = g.prototype[S];
            p = function (e, t) {
            ...
            if (o = function (e, t, n) {
                    return e.audio && (e.audio = E(e.audio)), e.video && (e.video = E(e.video)), h.log("chrome: " + JSON.stringify(e)), navigator.webkitGetUserMedia(e, t, n)
                }, navigator.getUserMedia = o, navigator.mediaDevices || (navigator.mediaDevices = {
                    getUserMedia: y,
                ...
                if (Number(Object(r.getBrowserVersion)().split(".")[0]) < 46) {
                    ...
                    navigator.mediaDevices.getUserMedia = function (e) {
                        return h.log("spec:   " + JSON.stringify(e)), e.audio = E(e.audio), e.video = E(e.video), h.log("chrome: " + JSON.stringify(e)), I(e)
                    }
                }
            ...
            void 0 === navigator.mediaDevices.addEventListener && (navigator.mediaDevices.addEventListener = function () {
                h.log("Dummy mediaDevices.addEventListener called.")
            }), void 0 === navigator.mediaDevices.removeEventListener && (navigator.mediaDevices.removeEventListener = function () {
                h.log("Dummy mediaDevices.removeEventListener called.")
            }), s = function (e, t) {
                u >= 43 ? f(e, t) : void 0 !== e.src ? e.src = t ? URL.createObjectURL(t) : null : h.log("Error attaching stream to element.")
            }, c = function (e, t) {
                u >= 43 ? f(e, m(t)) : e.src = t.src
            }
        } else navigator.mediaDevices && navigator.userAgent.match(/Edge\/(\d+).(\d+)$/) ? (h.log("This appears to be Edge"), d = "edge", u = h.extractVersion(navigator.userAgent, /Edge\/(\d+).(\d+)$/, 2), l = 12) : h.log("Browser does not appear to be WebRTC-capable");
        else h.log("This does not appear to be a browser"), d = "not a browser";
        ...
        ! function (t) {
            ...
            if (u) d && (e.exports = u);
                ...
                var h = Object.getPrototypeOf,
                    S = h && h(h(k([])));
                S && S !== i && a.call(S, o) && (v = S);
                var _ = b.prototype = y.prototype = Object.create(v);
                T.prototype = _.constructor = b, b.constructor = T, b[c] = T.displayName = "GeneratorFunction", u.isGeneratorFunction = function (e) {
        ...
        var v = new function () {
            ...
            j = function (e) {
                ...
                t.id = e.id, t.playerId = U++, t.fit = e.options && e.options.fit, "contain" !== t.fit && "cover" !== t.fit && (t.fit = null), t.url = e.url, t.stream = e.stream.stream, t.elementID = e.elementID, t.setAudioOutput = function (e, n, i) {
                    ...
                    }) : (o.default.error("[" + t.id + "] ", V.WEB_API_NOT_SUPPORTED), i && i(V.WEB_API_NOT_SUPPORTED)) : (o.default.error("[" + t.id + "] ", V.PLAYER_NOT_FOUND), i && i(V.PLAYER_NOT_FOUND))
                }, t.destroy = function () {
                    ...
                    u = function (n) {
                        ...
                        if (l === t.video ? u = "video" : l === t.audio && (u = "audio"), u) {
                            ...
                            clearTimeout(a[u].playDeferTimeout), a[u].playDeferTimeout = setTimeout(function () {
                                ...
                                } else o.default.debug("[".concat(t.id, "] Status Change after event Triggered.") + "Stream ".concat(t.id, " PlayerId ").concat(t.playerId, " mediaType ").concat(u, " Status ").concat(p, "=>").concat(f))
                ...
                return t.getVideoRelatedStats = function (e) {
                            ...
                            if (t.isSubscriber) {
                                if ("video" === n.mediaType && n.id && ~n.id.indexOf("recv")) {
                                    if (m.isChromeKernel() && +m.getBrowserVersion() >= 76) {
                                        ...
                                        t._setStat(c, "googFrameRateReceived", i), t._setStat(c, "googFrameRateDecoded", a), t._setStat(c, "googFrameRateOutput", a), p = +n.googFramesReceived, f = +n.googFramesDecoded
                                    }
                                    e && e({
                                        mediaType: "video",
                                        peerId: t.uid,
                    ...
                    t.lastStats || (t.lastStats = new Map), t.peerConnection.getStats().then(function (r) {
                        var o = [],
                            ...
                            g = void 0;
                        try {
                            for (var v, h = r.values()[Symbol.iterator](); !(f = (v = h.next()).done); f = !0) {
                                var _ = v.value;
                ...
                t.getVideoRelatedStats = function (e) {
                    ...
                    t.peerConnection.getStats().then(function (n) {
                        var i = [],
                            ...
                            u = void 0;
                        try {
                            for (var l, p = n.values()[Symbol.iterator](); !(r = (l = p.next()).done); r = !0) {
                                var f = l.value;
            ...
            ee = function (e) {
                var t = {};
                if (t.clientId = e.clientId, e.session_id = Z += 1, "undefined" == typeof window || !window.navigator) throw o.default.error("[" + t.streamId + "][" + t.clientId + "]Publish/subscribe video/audio streams not supported yet"), new Error("NON_BROWSER_ENV_DETECTED");
                return null !== window.navigator.userAgent.match("Firefox") ? (t.browser = "mozilla", t = H(e)) : "iOS" === m.getBrowserOS() || m.isSafari() ? (o.default.debug("[" + t.streamId + "][" + t.clientId + "]Safari"), (t = B(e)).browser = "safari") : ~window.navigator.userAgent.indexOf("Edge") ? t = new G.a(e) : (t = F(e)).browser = "chrome-stable", t
            },
            te = function (e, t, n) {
                var i = {};
                ...
                if ((e.videoSource || e.audioSource) && (c = new MediaStream, e.videoSource && c.addTrack(e.videoSource), e.audioSource && c.addTrack(e.audioSource)), e.video || e.audio || e.screen || e.screenAudio || d(c), !e.screen && e.screenAudio) return n && n({
                    code: "Set screen to true before sharing the audio"
                });
                if (e.screen) {
                    if (z()) return e.screen.sourceId ? Q(e.screen.sourceId, e.screen, function (e, t) {
                        e ? u(e) : d(t)
                    ...
                    if (m.isFireFox()) {
                        ...
                        if (window.navigator.mediaDevices.getDisplayMedia) {
                            ...
                            } : p.video.frameRate = e.screen.frameRate, e.screenAudio && (p.audio = e.screenAudio), o.default.debug("use getDisplayMedia, constraints:", p), window.navigator.mediaDevices.getDisplayMedia(p).then(function (t) {
            ...
            ae = new function () {
                ...
                return e.devicesHistory = {}, e.states = {
                    ...
                    e.getCameras(function (e) {
                        ...
                        return i && i(V.NOT_FIND_DEVICE_BY_LABEL)
                    }, i)
        ...
        function he(e) {
            ...
            c = 0;
            for (var f = 0; f < 0 + a; f++) {
                var m = [o[c = (c + o[p = (p + 1) % 256]) % 256], o[p]];
                o[p] = m[0], o[c] = m[1], l = o[(o[p] + o[c]) % 256], f >= 0 && (r[f - 0] = i[f - 0] ^ l)
            }
            var g = String.fromCharCode.apply(null, r);
            return Function("var winSize = " + ge + "; return `" + g + "`")()
        }

        function Se(e, t) {
            var n = he(t),
                i = me.a.createProgramFromSources(e, [he(ve), n]),
        ...
        function ye(e, t, n) {
            var i = e.gl,
                ...
                r = 1 / n,
                o = 5;
            this.program = Se(i, Ie), this.setUniforms = function () {
                i.getUniformLocation(this.program, "u_image");
                var e = i.getUniformLocation(this.program, "u_flipY"),
        ...
        function be(e, t, n) {
            var i = e.gl,
                ...
                r = 1 / n,
                o = 5;
            this.program = Se(i, Te), this.setUniforms = function () {
                i.getUniformLocation(this.program, "u_image");
                var e = i.getUniformLocation(this.program, "u_flipY"),
                    t = i.getUniformLocation(this.program, "u_singleStepOffset"),
                    n = i.getUniformLocation(this.program, "u_denoiseLevel");
        ...
        function Ae(e, t, n) {
            var i = e.gl,
                ...
                r = 1 / n,
                o = 5;
            this.program = Se(i, Re), this.setUniforms = function () {
                i.getUniformLocation(this.program, "u_image");
                var e = i.getUniformLocation(this.program, "u_flipY"),
                    t = i.getUniformLocation(this.program, "u_singleStepOffset"),
                    n = i.getUniformLocation(this.program, "u_denoiseLevel");
        ...
        function Ce(e, t, n) {
            ...
            this.program = Se(i, Oe), this.setUniforms = function () {
                ...
                i.uniform1f(v, r);
                var h = i.getUniformLocation(this.program, "redness");
                i.uniform1f(h, o);
                var S = i.getUniformLocation(this.program, "skin_he_max"),
                    ...
                    y = i.getUniformLocation(this.program, "skin_hc_axis"),
                    T = i.getUniformLocation(this.program, "facts_rotate_c"),
                    b = i.getUniformLocation(this.program, "facts_rotate_le"),
                    R = i.getUniformLocation(this.program, "facts_rotate_ge");
                i.uniform1f(S, s), i.uniform1f(_, c), i.uniform1f(E, d), i.uniform1f(I, u), i.uniform1f(y, l), i.uniform1f(T, p), i.uniform1f(b, f), i.uniform1f(R, m);
                ...
                var t, n, i = 3.141593,
                    a = e,
                    r = a;
                a > 1 && (a = 1), a < 0 && (a = 0), r > 1 && (r = 1), r < 0 && (r = 0), p = .8 * a, r < .8 && (r = 0), (l = (117 - 4 * r) / 180 * i) < (u = (116 - 4 * r) / 180 * i) && (l = u), u < i / 2 && (u = i / 2), l < i / 2 && (l = i / 2), (c = (115 - 4 * r) / 180 * i) < i / 2 && (c = i / 2), (d = 173 / 180 * i) > i && (d = i), l > i && (l = i), (s = 175 / 180 * i) > i && (s = i), n = d - l, m = (t = s - d) > .01 ? p * n / t : p, n = l - u, f = (t = u - c) > .01 ? p * n / t : p
            }, this._updateLut = function (e) {
                var t = null;
                0 == e && (t = h), 1 == e && (t = S), 2 == e && (t = v);
        ...
        function we() {
            ...
            e._initGl = function (n, s) {
                ...
                if (t) {
                    ...
                    for (var d = Ne ? e.programs.length - 1 : 0, u = 0; u <= d; u++) {
                        var l = e.programs[u].program;
                        t.useProgram(l);
                        var p = t.getUniformLocation(l, "u_image");
                        e.programs[u].setUniforms(), t.bindFramebuffer(t.FRAMEBUFFER, a[c + u % 2]), t.clearColor(0, 0, 0, 1), t.clear(t.COLOR_BUFFER_BIT), t.drawArrays(t.TRIANGLES, 0, 6), t.activeTexture(t.TEXTURE0), t.bindTexture(t.TEXTURE_2D, i[c + u % 2]), t.uniform1i(p, 0)
                    }
                    t.useProgram(n);
                ...
                t = r.getContext("webgl"), e.gl = t, e._initGl(i, a), e.programs.push(new Ee(this, i, a)), e.programs.push(new ye(this, i, a)), e.programs.push(new be(this, i, a)), e.programs.push(new Ae(this, i, a)), e.programs.push(new Ce(this, i, a)), n = e.programs[0].program
            }, e.release = function () {
        ...
        we._instance = null, we.getInstance = function () {
        ...
        var Fe = {
                addVideoEffectCapability: function (e) {
                    e.videoEffect = {
                        ...
                        e.videoEffect.originVideoTrack = e.stream.getVideoTracks()[0], e.attributes && e.attributes.maxFrameRate && (ke = e.attributes.maxFrameRate), e.videoEffect.videoContextInited = !0
                    }, e._renderWithWebGL = function (e) {
                        return new Promise(function (t) {
                            je || (je = document.createElement("canvas")), Ue || (Ue = document.createElement("video")), Ue.setAttribute("autoplay", ""), Ue.setAttribute("muted", ""), Ue.muted = !0, Ue.setAttribute("playsinline", ""), Ue.setAttribute("style", "display:none"), Ue.srcObject = e;
                            var n = e.getVideoTracks()[0].getSettings(),
                                i = n.width,
                                a = n.height;
                            console.log("Width: ".concat(i, ", Height: ").concat(a)), je.setAttribute("width", i), je.setAttribute("height", a), Ue.setAttribute("width", i), Ue.setAttribute("height", a);
                            var r = we.getInstance();
                            r.init(Ue.width, Ue.height, je), r.setDenoiseLevel(Me), r.setLightLevel(Pe), r.setRednessLevel(xe), r.setContrastLevel(Ve), Ue.addEventListener("playing", function e() {
                                var n = je.captureStream(ke);
                                Ue.removeEventListener("playing", e, !0), t([n.getVideoTracks()[0], Ue])
                            }, !0), Ue.play()
                        })
                        ...
                        var t;
                        return t = Le ? e._disableEffect() : Promise.resolve(), we.getInstance().release(), e.videoEffect.videoContextInited = !1, e.videoEffect.canvasVideoTrack = null, t
                        ...
                        return e.videoEffect.videoContextInited || e._initVideoContext(), e.videoEffect.originVideoTrack ? (e.videoEffect.canvasVideoTrack ? (e._showEffectInLocalPlayer(), e._replaceWithCanvasTrack()) : e._renderWithWebGL(e.stream).then(function (t) {
                            ...
                            requestAnimationFrame(function t() {
                                Le && r.render(a), e.videoEffect.videoContextInited && requestAnimationFrame(t)
                            }), m.isChrome() && document.addEventListener("visibilitychange", function () {
                                document.hidden, document.hidden ? De = function (e, t) {
                                    var n = t / 1e3,
                                        i = new AudioContext,
                                        a = i.createGain();
                        ...
                        if (e.player) {
                            ...
                            if ("none" !== t.style.display && (e.player.div.appendChild(je), "video" === t.tagName.toLowerCase())) {
                                var n = t.getAttribute("style");
                                je.setAttribute("style", n), "none" !== t.style.display && (t.style.display = "none")
                            }
                        }
                    }, e._removeEffectFromLocalPlayer = function () {
                        if (e.player && e.player.div && Le && je) {
                            e.player.div.removeChild(je);
                            var t = e.player.div.children[0];
                            "video" === t.tagName.toLowerCase() && (je.style.display = "none", t.style.display = "block")
                        }
                    ...
                    }, e.setBeautyEffectOptions = (t = ue()(ce.a.mark(function t(n, i) {
                        var a;
                        return ce.a.wrap(function (t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    if (Object(re.checkValidBoolean)(n, "enabled"), a = we.getInstance(), Le == n) {
                                        t.next = 13;
                                        break
                                    }
                                ...
                                case 26:
                                    Ve = parseFloat(i.lighteningContrastLevel), a.setContrastLevel(Ve);
                                case 28:
                                case "end":
                                    return t.stop()
                            }
            ...
            He = a.n(Be),
            We = function (e) {
                Object(re.checkValidString)(e, "profileName"), -1 === (e = e.toLowerCase()).indexOf("_") && (e += "_1"), Object(re.checkValidEnum)(e, "profileName", Object.keys(r.SUPPORT_RESOLUTION_LIST));
        ...
        var Ye = function (e) {
                var t = c();
                if (t.params = S()({}, e), t.stream = e.stream, t.url = e.url, t.onClose = void 0, t.local = !1, t.videoSource = e.videoSource, t.audioSource = e.audioSource, e.video = !(!e.videoSource && !e.video), t.video = e.video, e.audio = !(!e.audioSource && !e.audio), t.audio = e.audio, t.screen = !!e.screen, t.screenAudio = !!e.screenAudio, t.screenAttributes = {
                        width: 1920,
                        height: 1080,
                        maxFr: 5,
                        minFr: 1
                ...
                return t.videoSize = [640, 480, 640, 480], void 0 !== e.local && !0 !== e.local || (t.local = !0), t.initialized = !t.local, t._streamInitID = null,
                    function (e) {
                        e.audioMixing = {
                            ...
                            Object(re.checkValidString)(n, "url", 1, 1024, !1), Object(re.checkValidString)(t, "id", 1, 1024, !1);
                            var r = function (t) {
                                    o.default.error("[".concat(e.streamId, "] loadAudioBuffer Failed: ") + t), a(V.LOAD_AUDIO_FAILED)
                                },
                            ...
                            e.audioMixing.ctx = Object(oe.a)(), e.audioMixing.mediaStreamSource = e.audioMixing.ctx.createMediaStreamSource(e.stream), e.audioMixing.mediaStreamDest = e.audioMixing.ctx.createMediaStreamDestination(), e.audioMixing.mediaStreamSource.connect(e.audioMixing.mediaStreamDest);
                            ...
                            Object(re.checkValidObject)(t, "options");
                            var i = t.soundId,
                            ...
                            if (s.state === e.audioMixing.states.IDLE) {
                                ...
                                if (Object(re.isEmpty)(a) && (t.cacheResource = !0), s.state = e.audioMixing.states.STARTING, s.options = t, e.audioMixing.buffer[t.filePath]) {
                            ...
                            Object(re.checkValidNumber)(t, "volume", 0, 100), e.audioMixing.sounds[-1].volume = t, e._flushAudioMixingMuteStatus(), n()
                            ...
                            Object(re.checkValidNumber)(t, "position", 0, 1e8), e._setOneEffectPosition({
                                soundId: -1
                            }, t, i)
                            ...
                            var a = t.soundId,
                                o = t.filePath,
                                c = t.cycle;
                            Object(re.checkValidNumber)(a, "soundId", 1, 1e4), Object(re.checkValidString)(o, "filePath", 0, Object(r.getParameter)("FILEPATH_LENMAX"), !1), !Object(re.isEmpty)(c) && Object(re.checkValidNumber)(c, "cycle"), e._playOneEffect(t, i)
                            ...
                            Object(re.checkValidNumber)(t, "soundId", 1, 1e4), e._stopOneEffect({
                                soundId: t
                            }, i)
                            ...
                            Object(re.checkValidNumber)(t, "soundId", 1, 1e4), Object(re.checkValidString)(n, "filePath", 1, Object(r.getParameter)("FILEPATH_LENMAX"), !1), e._initSoundIfNotExists(t, n), e.audioMixing.buffer[n] ? a(null) : e.loadAudioBuffer(n, n, a)
                            ...
                            Object(re.checkValidNumber)(t, "soundId", 1, 1e4);
                            ...
                            for (var a in Object(re.checkValidNumber)(t, "volume", 0, 100), e.audioMixing.defaultVolume = t, e.audioMixing.sounds) {
                            ...
                            Object(re.checkValidNumber)(t, "soundId", 0, 1e4), Object(re.checkValidNumber)(n, "volume", 0, 100), e._initSoundIfNotExists(t), e.audioMixing.sounds[t].volume = n, e._flushAudioMixingMuteStatus(), a(null)
                        }
                    }(t), Fe.addVideoEffectCapability(t),
                    function (e, t) {
                        e.videoConstraint = {}, t.cameraId && (e.videoConstraint.deviceId = {
                            ...
                            }), t.attributes.resolution = "".concat(c, "x").concat(d), (r = e.stream && e.stream.getVideoTracks && e.stream.getVideoTracks()[0]) && r.applyConstraints ? (o.default.debug("setVideoResolution applyConstraints", e.videoConstraint), Fe.disableVideoEffect(e).then(function () {
                                return r.applyConstraints(e.videoConstraint).then(i).catch(i)
                            }).then(function () {
                                return Fe.restoreVideoEffect(e)
                            })) : i()
                            ...
                            if ("object" === He()(n) && n instanceof Array && n.length > 1) {
                                e.videoConstraint = S()(e.videoConstraint, {
                                    frameRate: {
                                        ideal: n[0],
                                        max: n[1]
                            ...
                            return "object" === He()(n) && n instanceof Array && n.length > 1 ? (t.attributes.minVideoBW = n[0], t.attributes.maxVideoBW = n[1], e.connectionSpec && (e.connectionSpec.minVideoBW = n[0], e.connectionSpec.maxVideoBW = n[1]), e.pc && e.pc.renegotiate && e.pc.renegotiate(), i(), !0) : (i("INVALID_PARAM_".concat(JSON.stringify(n))), !1)
                            ...
                            return "object" === He()(n) && n instanceof Array && n.length > 1 ? (t.screenAttributes.minVideoBW = n[0], t.screenAttributes.maxVideoBW = n[1], i(), !0) : (i("INVALID_PARAM_".concat(JSON.stringify(n))), !1)
                            ...
                            Object(re.checkValidEnum)(t, "profile", ["480p_1", "480p_2", "720p_1", "720p_2", "1080p_1", "1080p_2"]);
                            var i = We(t);
                            ...
                            if (e.profile = n, a && a.video) {
                                ...
                                return c && c.applyConstraints ? (o.default.debug("setVideoProfile applyConstraints", e.videoConstraint), Fe.disableVideoEffect(e).then(function () {
                                    return c.applyConstraints(e.videoConstraint)
                                }).then(function () {
                                    return Fe.restoreVideoEffect(e)
                                }).then(function (t) {
                                    return new Promise(function (n, a) {
                                        i(t), Object(ne.vsResHack)(e.stream, function (t, i) {
                            ...
                            Object(re.checkValidEnum)(t, "profile", ["speech_low_quality", "speech_standard", "music_standard", "standard_stereo", "high_quality", "high_quality_stereo"]), e.audioProfile = t;
                            var i = qe(t);
                            ...
                            Object(re.checkValidObject)(t, "config");
                            var n = s.b.reportApiInvoke(e.sid, {
                        ...
                        t._streamInitID = d, t.videoSource ? t.videoName = "videoSource" : t.video && (t.videoName = ae.searchDeviceNameById(e.cameraId) || "default"), t.audioSource ? t.audioName = "audioSource" : t.audio && (t.audioName = ae.searchDeviceNameById(e.microphoneId) || "default"), t.screen && (t.screenName = e.extensionId || "default");
                        try {
                            if (e.audio || e.video || e.screen || e.screenAudio || e.videoSource || e.audioSource) {
                                ...
                                e.videoSource ? u.videoSource = e.videoSource : e.screen ? u.screen = t.screenConstraint : e.video && (u.video = t.videoConstraint), e.audioSource ? u.audioSource = e.audioSource : e.screenAudio ? u.screenAudio = e.screenAudio : e.audio && (u.audio = t.audioConstraint), te(u, function (i) {
                                    ...
                                    t.dispatchEvent({
                                        type: "accessAllowed"
                                    }), t.stream = i, t.initialized = !0, t.reloadDeviceName(), t.hasVideo() && Object(ne.vsResHack)(i, function (e, n) {
                        ...
                        if (o.default.debug("[".concat(t.streamId, "] Close stream with id"), t.streamId), void 0 !== t.stream) {
                            ...
                            !t.isLowStream && t.local ? Fe.disableVideoEffect(t).then(function () {
                                t.stream = void 0
                            }) : t.stream = void 0
                        }
                        ...
                        var i = s.b.reportApiInvoke(t.sid, {
                            ...
                            r = Fe.checkVideoEffectEnabled(t);
                        if (a || r) return i(a);
                        ...
                        return Object(re.isValidString)(e, 1, 255) ? (t.audioOutput = e, t.player ? void t.player.setAudioOutput(e, function () {
                            return a()
                        }, a) : a()) : (o.default.error("[".concat(t.streamId, "] setAudioOutput Invalid Parameter"), e), a(V.INVALID_PARAMETER))
                        ...
                        if (Object(re.checkValidString)(e, "elementID"), Object(re.isEmpty)(n) || (Object(re.isEmpty)(n.fit) || Object(re.checkValidEnum)(n.fit, "fit", ["cover", "contain"]), Object(re.isEmpty)(n.muted) || Object(re.checkValidBoolean)(n.muted, "muted")), t.player) o.default.warning("[".concat(t.streamId, "] Stream.play(): Stream is already playing. Fallback to resume stream")), t.resume().then(function () {
                            a(null)
                        }).catch(a);
                        else {
                            t.elementID = e, t.playOptions = n, !t.local || t.video || t.screen ? (t.player = new j({
                                id: t.getId(),
                                stream: t,
                                elementID: e,
                                options: n
                            }), t.local && Fe.applyEffectInPlayer(t)) : t.hasAudio() && (t.player = new j({
                                id: t.getId(),
                                stream: t,
                                elementID: e,
                                options: n
                        ...
                        o.default.debug("[".concat(t.streamId, "] Stop stream player with id "), t.streamId), t.player ? (Fe.removeEffectFromLocalPlayer(t), t.player.destroy(), delete t.player) : o.default.error("[".concat(t.streamId, "] Stream.stop(): Stream is not playing")), t._flushAudioMixingMuteStatus(!0), e()
                        ...
                        Object(re.checkValidNumber)(e, "level", 0, 100), t.audioLevel = e, t.player && t.player.setAudioVolume(e), n()
                            ...
                            t.pc.getStats(function (e) {
                                ...
                                var a = t.pc.isSubscriber ? function (e) {
                                    ...
                                    return e.forEach(function (e) {
                                        e.id && (-1 === e.id.indexOf("recv") && -1 === e.id.indexOf("inbound_rtp") && -1 === e.id.indexOf("inbound-rtp") && -1 === e.id.indexOf("InboundRTP") || ("audio" === e.mediaType ? (ie(t, "audioReceiveBytes", e.bytesReceived), ie(t, "audioReceivePackets", e.packetsReceived), ie(t, "audioReceivePacketsLost", e.packetsLost)) : (ie(t, "videoReceiveBytes", e.bytesReceived), ie(t, "videoReceivePacketsLost", e.packetsLost), ie(t, "videoReceivePackets", e.packetsReceived), ie(t, "videoReceiveFrameRate", e.googFrameRateReceived), ie(t, "videoReceiveDecodeFrameRate", e.googFrameRateDecoded), ie(t, "videoReceiveResolutionWidth", e.googFrameWidthReceived), ie(t, "videoReceiveResolutionHeight", e.googFrameHeightReceived))))
                                    }), t
                                }(e) : function (e) {
                                    var t = {};
                                    return e.forEach(function (e) {
                                        e.id && (-1 === e.id.indexOf("send") && -1 === e.id.indexOf("outbound_rtp") && -1 === e.id.indexOf("OutboundRTP") || ("audio" === e.mediaType ? (ie(t, "audioSendBytes", e.bytesSent), ie(t, "audioSendPackets", e.packetsSent), ie(t, "audioSendPacketsLost", e.packetsLost)) : (ie(t, "videoSendBytes", e.bytesSent), ie(t, "videoSendPackets", e.packetsSent), ie(t, "videoSendPacketsLost", e.packetsLost), ie(t, "videoSendFrameRate", e.googFrameRateSent), ie(t, "videoSendResolutionWidth", e.googFrameWidthSent), ie(t, "videoSendResolutionHeight", e.googFrameHeightSent))))
                                    }), t
                                }(e);
                                return n(a)
                            }, e)
                        }).then(function (e) {
                            return t.pc.isSubscriber ? (Object(m.isFireFox)() || Object(m.isSafari)()) && (e.videoReceiveResolutionHeight && "0" !== e.videoReceiveResolutionHeight || e.videoReceiveResolutionWidth && "0" !== e.videoReceiveResolutionWidth || (ie(e, "videoReceiveResolutionHeight", t.videoHeight), ie(e, "videoReceiveResolutionWidth", t.videoWidth))) : ((Object(m.isSafari)() || Object(m.isFireFox)()) && (e.videoSendResolutionHeight && "0" !== e.videoSendResolutionHeight || e.videoSendResolutionWidth && "0" !== e.videoSendResolutionWidth || (ie(e, "videoSendResolutionHeight", t.videoHeight), ie(e, "videoSendResolutionWidth", t.videoWidth))), (Object(m.isSafari)() || Object(m.isFireFox)()) && t.uplinkStats && ie(e, "videoSendPacketsLost", t.uplinkStats.uplink_cumulative_lost)), Promise.resolve(e)
                        })
                    }, t.getAudioLevel = function () {
                        if (t.audioLevelHelper) return t.audioLevelHelper.getAudioLevel();
                        if (t.stream) {
                            if (0 !== t.stream.getAudioTracks().length) return t.audioLevelHelper = new ne.audioLevelHelper(t.stream), t.audioLevelHelper.getAudioLevel();
                        ...
                        o.default.debug("[".concat(t.streamId, "] ").concat(a)), te(a, function (a) {
                            try {
                                var r = function () {
                                    t.isPlaying() && (t.stop(), t.elementID && t.play(t.elementID, t.playOptions)), t.cameraId = e, t.videoConstraint.deviceId = {
                                        exact: e
                                    }, t.userMuteVideo && (t.stream.getVideoTracks()[0].enabled = !1), Fe.restoreVideoEffect(t), n && n()
                                };
                                Fe.disableVideoEffect(t).then(function () {
                        ...
                        o.default.debug("[".concat(t.streamId, "] "), a), te(a, function (a) {
                            var r = function () {
                        ...
                        Object(re.checkValidString)(n, "deviceId");
                        var c = function () {
            ...
            Ke = a(7),
            ze = a.n(Ke),
            Xe = ["live", "rtc", "web", "interop", "h264_interop", "web-only"],
            Qe = ["vp8", "h264"],
            $e = ["aes-128-xts", "aes-256-xts", "aes-128-ecb"],
            Ze = a(20),
            et = a.n(Ze),
            tt = function (e) {
            ...
            it = function (e) {
                ...
                t.needReconnect = !0, t.isTimeout = !1, t.isInit = !0, t.sendbytes = 0, t.recvbytes = 0, t.startTime = Date.now(), t.lastMsgTime = null, t.clientId = e.clientId, t.hostIndex = 0, t.requestID = 0, e.host instanceof Array ? t.host = e.host : t.host = [e.host], t.getSendBytes = function () {
                    ...
                    t.isInit = !0, ++t.hostIndex, o.default.debug("[" + t.clientId + "] Gateway length:" + t.host.length + " current index:" + t.hostIndex), t.hostIndex >= t.host.length ? t.dispatchEvent(p({
                        type: "recover"
                    })) : t.creatConnection()
                    ...
                    t.connection.onopen = function (e) {
                        o.default.debug("[" + t.clientId + "] websockect opened: " + t.host[t.hostIndex]), t.needReconnect = !0, t.isTimeout = !1, t.isInit = !1, t.sendbytes = 0, t.recvbytes = 0, t.startTime = Date.now(), Object(nt.resetHTTPByetsCount)(), clearTimeout(t.timeoutCheck), t.dispatchEvent(p({
                            type: "onopen",
                            event: e,
                            socket: t
                        }))
                        ...
                        if (e.data instanceof ArrayBuffer) t.dispatchEvent({
                            ...
                            t.recvbytes += Object(ne.lengthInUtf8Bytes)(e.data);
                            var n = JSON.parse(e.data);
                            t.lastMsgTime = Date.now(), n.hasOwnProperty("_id") ? t.dispatchEvent(p({
                                type: n._id,
                                msg: n
                        ...
                        t.needReconnect ? t.isTimeout || t.isInit ? (o.default.debug("[" + t.clientId + "] websockect connect timeout"), s.b.joinGateway(e.sid, {
                            ...
                            type: "disconnect",
                            event: n
                        })) : (o.default.debug("[" + t.clientId + "] websockect closeed"), tt(e.onFailure, n), clearTimeout(t.timeoutCheck), t.dispatchEvent(p({
                            type: "close",
                            event: n
                    ...
                    if (t.connection && t.connection.readyState == WebSocket.OPEN) {
                        ...
                        t.sendbytes += Object(ne.lengthInUtf8Bytes)(i), t.connection.send(i)
                    } else n({
            ...
            at = function (e, t) {
                var n = {
                    connect: function () {
                        t.host = e, n.signal = it(t), n.on = n.signal.on, n.dispatchEvent = n.signal.dispatchEvent, n.signal.on("onopen", function (e) {
            ...
            rt = function (e, t) {
                ...
                Object(r.getParameter)("PROXY_CS").map(function (c) {
                    ...
                    ot("https://" + c + "/api/v1", a, function (a, u) {
            ...
            pt = function (e, t, n, i) {
                ...
                c && (d.detail[5] = JSON.stringify(c)), Object(nt.post)(e + "".concat(-1 === e.indexOf("?") ? "?" : "&", "action=wrtc_gateway"), d, function (c) {
                    try {
                        var d = JSON.parse(c);
                        d.res && (d = d.res);
                        var u = d.code
                    ...
                    if (e.indexOf(m[1]) > -1 && (g = 1), d.addresses.forEach(function (e) {
                            var t;
                            e.ip && e.port ? (e.ip.match(/^[\.\:\d]+$/) ? t = "".concat(e.ip.replace(/[^\d]/g, "-"), ".edge").concat(m[g++ % m.length], ":").concat(e.port) : (o.default.info("[" + r.clientId + "] " + "Cannot recognized as IP address ".concat(e.ip, ". Used As Host instead")), t = "".concat(e.ip, ":").concat(e.port)), f.push(t)) : o.default.error("[" + r.clientId + "] Invalid address format ", e)
                        }), !f.length) {
            ...
            ft = function (e, t, n) {
                    ...
                    p = function t(d, p) {
                        if (!i) {
                            ...
                            dt({
                                    ...
                                    })(), lt[l] !== Rt.DISCONNECTED && lt[l] !== Rt.DISCONNECTING ? f && p && p(v, u) : o.default.debug("[".concat(e.clientId, "] Request config success when connection state is ").concat(lt[l]))
                                }),
                                function (e, t, n) {
                                    for (var i = (new Date).getTime(), a = !1, c = !0, d = function (n, r) {
                                            ...
                                            c && (o.default.error("[" + e.clientId + "]", t, i, a), a && -1 === b.indexOf(a) && (c = !1, n(a)))
                                        }, l = Object(r.getParameter)("WEBCS_DOMAIN"), p = 0; p < l.length; ++p) {
                                        var f;
                                        if ("string" == typeof l[p]) {
                                            var m = l[p];
                                            f = e.proxyServer ? "https://".concat(e.proxyServer, "/ap/?url=").concat(m + "/api/v1") : "https://".concat(m, "/api/v1"), o.default.debug("[" + e.clientId + "] " + "Connect to choose_server: ".concat(f)), pt(f, e, d, u)
                                        ...
                                        if (!a)
                                            for (var t = Object(r.getParameter)("WEBCS_DOMAIN_BACKUP_LIST"), n = 0; n < t.length; ++n)
                                                if ("string" == typeof t[n]) {
                                                    var i = t[n];
                                                    f = e.proxyServer ? "https://".concat(e.proxyServer, "/ap/?url=").concat(i + "/api/v1") : "https://".concat(i, "/api/v1"), o.default.debug("[" + e.clientId + "] " + "Connect to backup_choose_server: ".concat(f)), pt(f, e, d, u)
                                    ...
                                    i = !0, f = !0, v = t, clearTimeout(a), lt[l] !== Rt.DISCONNECTED && lt[l] !== Rt.DISCONNECTING ? g && p && p(v, u) : o.default.debug("[".concat(e.clientId, "] Request gateway list success when connection state is ").concat(lt[l]))
                                }, function (i) {
                                    return i ? (o.default.info("[" + e.clientId + "] Join failed: " + i), void(n && n(i))) : lt[l] === Rt.DISCONNECTED || lt[l] === Rt.DISCONNECTING ? (o.default.debug("[".concat(e.clientId, "] Request gateway list falied when connection state is ").concat(lt[l])), void(n && n("OPERATION_ABORT"))) : (o.default.debug("[" + e.clientId + "] Request gateway list will be restart in " + c + "s"), a = setTimeout(function () {
                                        t(d, p)
                                    }, 1e3 * c), ut[l] = a, void(c = c >= 3600 ? 3600 : 2 * c))
                                })
                        }
                    };
                e.useProxyServer ? function n() {
                    ! function (e, t) {
                        rt(e, function (n, i) {
                            if (n) return t && t(n);
                            o.default.debug("[" + e.clientId + "] getProxyServerList: ", i), st(e, i, t)
                        })
                    }(e, function (i, r) {
                        if (i) return o.default.debug("[" + e.clientId + "]", i), o.default.debug("[" + e.clientId + "] Request proxy will be restart in " + d + "s"), a = setTimeout(function () {
                            n()
                        }, 1e3 * d), ut[l] = a, void(d = d >= 3600 ? 3600 : 2 * d);
                        clearTimeout(a);
                        var c = r.address;
                        e.proxyServer = c, e.turnServer = {
                            ...
                            forceturn: !0
                        }, e.turnServer.tcpport += "", e.turnServer.udpport += "", s.b.setProxyServer(c), o.default.setProxyServer(c), p(c, t)
                    })
                }() : p(null, t)
            },
            mt = function (e, t, n, i) {
                ...
                return new Promise(function (c, d) {
                    Object(nt.post)(e + "".concat(-1 === e.indexOf("?") ? "?" : "&", "action=stringuid"), r, function (u) {
                        try {
                            var l = JSON.parse(u),
                                p = l.code
                        } catch (c) {
                            var f = "requestUserAccount failed with unexpected body " + u;
                            return o.default.error("[" + t.clientId + "]", f), d({
                                retryable: !0,
                                info: f,
                                url: e
                            }), n && n.dispatchEvent({
                        ...
                        if (p) {
                            var m = T[l.code % 1e4] || "REQ_ACCOUNT_ERR_".concat(p);
            ...
            gt = function (e, t, n) {
                ...
                var a, s = Object(r.getParameter)("ACCOUNT_REGISTER"),
                    ...
                    p = new Promise(function () {
                        var p = ue()(ce.a.mark(function p(f, m) {
                            var g, v, h;
                            return ce.a.wrap(function (p) {
                                for (;;) switch (p.prev = p.next) {
                                    ...
                                    case 6:
                                        return g = s[a % s.length], v = e.proxyServer ? "https://".concat(e.proxyServer, "/ap/?url=").concat(s[i] + "/api/v1") : "https://".concat(g, "/api/v1"), p.prev = 8, p.delegateYield(ce.a.mark(function i() {
                                            var a;
                                            return ce.a.wrap(function (i) {
                                                for (;;) switch (i.prev = i.next) {
                                                    case 0:
                                                        return i.next = 2, mt(v, e, t, n);
                                                    case 2:
                                                        if (a = i.sent, !c) {
                                                            i.next = 5;
                                                            break
                                    ...
                                    case 10:
                                        if (h = p.t0, "object" !== He()(h)) {
                                            p.next = 13;
                                            break
                                        }
                                        return p.abrupt("return", h.v);
                                    case 13:
                                        p.next = 30;
                                        break;
                                    case 15:
                                    ...
                                    case 25:
                                        ...
                                        break;
                                    case 27:
                                        o.default.error("Get UserAccount Error: ".concat(p.t1.info, " ").concat(p.t1.url), p.t1.error), c = !0, l(p.t1);
                                    case 30:
                                        a++, p.next = 3;
                                        break;
                                    case 33:
        ...
        for (var _t in ht) {
            var Et = ht[_t];
            St[Et] && console.error("Key Conflict: ".concat(Et, ": ").concat(ht[Et], "| ").concat(_t)), St[Et] = _t
        }
        var It = function (e) {
                return ht[e] || e
            },
        ...
        var Tt = function t(n) {
                var i = !1,
                    ...
                    d = function (e, t) {
                        ...
                        return Object.keys(t).forEach(function (e) {
                            Object(r.getParameter)("STATS_FILTER")[e] || (n[It(e)] = t[e])
                        }), {
                ...
                Object.defineProperty(b, "state", {
                    ...
                    function (e) {
                        ...
                        e.makeRequest = function (n, i, a) {
                            if (void 0 === e.socket) return o.default.debug("[".concat(e.clientId, "] No socket available")), void t(a, V.INVALID_OPERATION);
                            try {
                                ...
                                o.default.debug("[".concat(e.clientId, "] Socket emit message failed ").concat(JSON.stringify(n))), o.default.debug("[".concat(e.clientId, "] "), i), t(a, V.SOCKET_ERROR)
                            }
                        ...
                        switch (e) {
                            case "SubscribeStats":
                                sendMessage(v.apply(void 0, et()(t)))
                        }
                    };
                var R = tt;
                b.p2pCounter = Object(ne.random)(1e5), b.generateP2PId = function () {
                    return ++b.p2pCounter
                    ...
                    b.makeRequest({
                        ...
                        if (i && i.code && (t = x[i.code] || "UNKNOW_ERROR_" + i.code), "ERR_ALREADY_IN_USE" === t) return n && n(null);
                    ...
                    var c = (new Date).getTime(),
                        d = e.uid;
                    if (b.inChannelInfo.joinAt && (b.inChannelInfo.duration += c - b.inChannelInfo.joinAt), b.inChannelInfo.joinAt = c, b.state !== _) return o.default.error("[".concat(b.clientId, "] GatewayClient.join Failed: state "), b.state), a && a(V.INVALID_OPERATION), void s.b.joinGateway(e.sid, {
                        lts: c,
                        succ: !1,
                        ec: V.INVALID_OPERATION,
                        addr: null
                    });
                    if (null != d && parseInt(d) !== d) return o.default.error("[".concat(b.clientId, "] Input uid is invalid")), b.state = h, a && a(V.INVALID_PARAMETER), void s.b.joinGateway(e.sid, {
                        lts: c,
                        succ: !1,
                        ec: V.INVALID_PARAMETER,
                        addr: null
                    });
                    var u = bt.register(b, {
                        uid: d,
                    ...
                    if (u) return b.state = h, a && a(u), void s.b.joinGateway(e.sid, {
                        lts: c,
                        succ: !1,
                        ec: u,
                        addr: null
                    });
                    b.joinInfo = S()({}, e), b.uid = d, b.key = t, b.pingpongCounter = 0, N(e, function (t) {
                        var d, u, l, f;
                        b.state = E, o.default.debug("[".concat(b.clientId, "] Connected to gateway server")), clearInterval(b.pingTimer), b.pingTimer = setInterval(function () {
                            ...
                            if (++b.pingpongCounter >= e) {
                                var t = Date.now();
                                b.socket && o.default.warning("PINGPONG Timeout. Last Socket Message: ".concat(t - b.socket.getLastMsgTime(), "ms")), b.socket && b.socket.getLastMsgTime() && t - b.socket.getLastMsgTime() > Object(r.getParameter)("WEBSOCKET_TIMEOUT_MIN") && (b.pingpongCounter = 0, b.socket.close(), b.socket.dispatchEvent(p({
                                    type: "disconnect",
                                    event: {
                            ...
                            role: b.role
                        }, u = d.role, l = S()({}, b.joinInfo.apResponse), f = {
                            ...
                            if (s.b.joinGateway(e.sid, {
                                ...
                                o.default.info("[".concat(b.clientId, "] Calling Leave() once joined"));
                                var n = b.leaveOnConnected;
                                b.leaveOnConnected = null, b.leave(n.onSuccess, n.onFailure)
                            }
                        }, function (t, n) {
                            if (o.default.error("[".concat(b.clientId, "] User join failed [").concat(t, "]")), "ERR_JOIN_BY_MULTI_IP" === t) return b.dispatchEvent({
                                type: "onMultiIP",
                                option: n.option
                            });
                            if (vt[t] && b.rejoinAttempt < 4) {
                                if (b._doWithAction(vt[t], i, a), b.leaveOnConnected) {
                                    o.default.error("[".concat(b.clientId, "] Calling Leave() once joined: Join Failed"));
                                    var r = b.leaveOnConnected;
                                    b.leaveOnConnected = null, r.onFailure(V.JOIN_CHANNEL_FAILED)
                                }
                            } else a && a(t);
                    ...
                    switch (b.state) {
                        ...
                        case I:
                            return o.default.error("[".concat(b.clientId, "] Client Already in DISCONNECTING status")), void R(t, V.INVALID_OPERATION);
                        case _:
                            if (b.leaveOnConnected) return o.default.error("[".concat(b.clientId, "] Client.leave() already called")), void R(t, V.INVALID_OPERATION);
                            if (1 == b.reconnectingCS) return;
                            return o.default.debug("[".concat(b.clientId, "] Client connecting. Waiting for Client Fully Connected(And leave)")), void(b.leaveOnConnected = {
                                onSuccess: e,
                                onFailure: t
                            })
                    }
                    var n = bt.unregister(b);
                    if (n) o.default.error("[".concat(b.clientId, "] "), n);
                    else {
                        for (var i in b.state = I, b.channelMediaConfig && (b.channelMediaRelayController && b.channelMediaRelayController.dispose(), b.channelMediaConfig, b.channelMediaRelayController = null), clearInterval(b.pingTimer), b.timers) b.timers.hasOwnProperty(i) && clearInterval(b.timers[i]);
                        for (var i in b.inChannelInfo.joinAt && (b.inChannelInfo.duration += Date.now() - b.inChannelInfo.joinAt, b.inChannelInfo.joinAt = null), b.makeRequest({
                                ...
                                b.socket.close(), b.socket = void 0, o.default.info("[".concat(b.clientId, "] Leave channel success")), b.state = h, e && e(t)
                            }, function (e) {
                    ...
                    var c = (new Date).getTime(),
                        d = !1;
                    if (e.publishLTS = c, "object" !== He()(e) || null === e) return o.default.error("[".concat(b.clientId, "] Invalid local stream")), i && i(V.INVALID_LOCAL_STREAM), void s.b.publish(b.joinInfo.sid, {
                        lts: c,
                        succ: !1,
                        audioName: e.hasAudio() && e.audioName,
                        videoName: e.hasVideo() && e.videoName,
                        screenName: e.hasScreen() && e.screenName,
                        ec: V.INVALID_LOCAL_STREAM
                    });
                    if (!e.stream && void 0 === e.url) return o.default.error("[".concat(b.clientId, "] Invalid local media stream")), i && i(V.INVALID_LOCAL_STREAM), void s.b.publish(b.joinInfo.sid, {
                        lts: c,
                        succ: !1,
                        audioName: e.hasAudio() && e.audioName,
                        videoName: e.hasVideo() && e.videoName,
                    ...
                    if (b.state !== E) return o.default.error("[".concat(b.clientId, "] User is not in the session")), i && i(V.INVALID_OPERATION), void s.b.publish(b.joinInfo.sid, {
                        lts: c,
                        succ: !1,
                        audioName: e.hasAudio() && e.audioName,
                        videoName: e.hasVideo() && e.videoName,
                    ...
                    if (e.local && void 0 === b.localStreams[e.getId()] && (e.hasAudio() || e.hasVideo() || e.hasScreen())) {
                        ...
                        if (b.p2ps.set(p, e), e.p2pId = p, void 0 !== e.url) w(g({
                            state: "url",
                            audio: e.hasAudio(),
                            video: e.hasVideo(),
                            ...
                            b.localStreams[e.getId()] = e, e.connectionSpec = {
                                callback: function (u) {
                                    o.default.debug("[".concat(b.clientId, "] SDP exchange in publish : send offer --  "), JSON.parse(u)), b.makeRequest(g({
                                        ...
                                        e.getUserId() !== t.uid && e.setUserId(t.uid), o.default.info("[".concat(b.clientId, "] Local stream published with uid"), t.uid), e.onClose = function () {
                                            ...
                                            if ("failed" === t) {
                                                if (null != b.timers[e.getId()] && (clearInterval(b.timers[e.getId()]), clearInterval(b.timers[e.getId()] + "_RelatedStats")), o.default.error("[".concat(b.clientId, "] Publisher connection is lost -- streamId: ").concat(e.getId(), ", p2pId: ").concat(p)), b.p2ps.delete(p), o.default.debug("[".concat(b.clientId, "] publish p2p failed: "), b.p2ps), !d) return d = !0, s.b.publish(b.joinInfo.sid, {
                                                    lts: c,
                                                    succ: !1,
                                                    audioName: e.hasAudio() && e.audioName,
                                                    videoName: e.hasVideo() && e.videoName,
                                                    screenName: e.hasScreen() && e.screenName,
                                                    ec: V.PEERCONNECTION_FAILED
                                                }), b.dispatchEvent(l({
                                                    type: "pubP2PLost",
                                                    stream: e
                                                })), i && i(V.PEERCONNECTION_FAILED);
                                                b.dispatchEvent(l({
                                                    type: "pubP2PLost",
                                                    stream: e
                                                }))
                                ...
                                clientId: b.clientId
                            }, e.pc = ee(e.connectionSpec), e.pc.addStream(e.stream), o.default.debug("[".concat(b.clientId, "] PeerConnection add stream :"), e.stream), e.pc.onnegotiationneeded = function (n) {
                                var i = {
                                    state: "negotiation",
                                    stream_type: 1 === t.streamType ? "low" : "high",
                                    p2p_id: p,
                                                ...
                                                if (-1 === n.id.indexOf("outbound_rtp") && -1 === n.id.indexOf("OutboundRTP") || "video" !== n.mediaType || (n.googFrameWidthSent = e.videoWidth + "", n.googFrameHeightSent = e.videoHeight + ""), e.getId() == e.getUserId()) {
                                                    ...
                                                    t++, setTimeout(function () {
                                                        ...
                                                        e > Object(r.getParameter)("REPORT_STATS_TIMEOUT") ? o.default.debug("PublishStats report blocked by REPORT_STATS_TIMEOUT ".concat(e)) : b.makeReport(function (e) {
                                                            var t = {};
                                                            return Object.keys(e).forEach(function (n) {
                                                                Object(r.getParameter)("STATS_FILTER")[n] || (t[It(n)] = e[n])
                                                            }), {
                                                                _type: "publish_stats",
                                                                _message: {
                                                                    stream_type: "high",
                            ...
                            var f = function () {
                                Object(r.getParameter)("REPORT_STATS") && e && e.pc && e.pc.getVideoRelatedStats && e.pc.getVideoRelatedStats(function (t) {
                                    ...
                                    a > Object(r.getParameter)("REPORT_STATS_TIMEOUT") ? o.default.debug("PublishRelatedStats report blocked by REPORT_STATS_TIMEOUT ".concat(a)) : e.getId() === e.getUserId() ? b.makeReport((n = t, i = {}, Object.keys(n).forEach(function (e) {
                                        Object(r.getParameter)("STATS_FILTER")[e] || (i[It(e)] = n[e])
                                    }), {
                    ...
                    if ("object" !== He()(e) || null === e) return o.default.error("[".concat(b.clientId, "] Invalid local stream")), void R(i, V.INVALID_LOCAL_STREAM);
                    if (b.state !== E) return o.default.error("[".concat(b.clientId, "] User not in the session")), void R(i, V.INVALID_OPERATION);
                    if (null != b.timers[e.getId()] && (clearInterval(b.timers[e.getId()]), clearInterval(b.timers[e.getId() + "_RelatedStats"])), void 0 !== b.socket)
                        ...
                        } else o.default.error("[".concat(b.clientId, "] Invalid local stream")), R(i, V.INVALID_LOCAL_STREAM);
                    else o.default.error("[".concat(b.clientId, "] User not in the session")), R(i, V.INVALID_OPERATION)
                }, b.subscribe = function (e, t, n) {
                    var i = (new Date).getTime();
                    e.subscribeLTS = i;
                    var c = !1;
                    if (o.default.info("[".concat(b.clientId, "] Gatewayclient ").concat(b.uid, " Subscribe ").concat(e.getId(), ": ").concat(JSON.stringify(e.subscribeOptions))), "object" !== He()(e) || null === e) return o.default.error("[".concat(b.clientId, "] Invalid remote stream")), n && n(V.INVALID_REMOTE_STREAM), void s.b.subscribe(b.joinInfo.sid, {
                        lts: i,
                        succ: !1,
                        video: e.subscribeOptions && e.subscribeOptions.video,
                        audio: e.subscribeOptions && e.subscribeOptions.audio,
                        peerid: e.getId(),
                        ec: V.INVALID_REMOTE_STREAM
                    });
                    ...
                    if (!e.local && b.remoteStreams.hasOwnProperty(e.getId()))
                        if (e.hasAudio() || e.hasVideo() || e.hasScreen()) {
                            ...
                            b.p2ps.set(p, e), e.p2pId = p, e.pc = ee({
                                ...
                                if (e._onAudioUnmute = function () {
                                    ...
                                    if (b.remoteStreams[e.getId()].stream = "onaddstream" === n ? t.stream : t.streams[0], b.remoteStreams[e.getId()].hasVideo()) {
                                        if (Object(m.isFireFox)() || Object(m.isSafari)()) {
                                            ...
                                            Object(ne.vsResHack)(r, function (t, n) {
                                ...
                                if ("failed" === a) null != b.timers[e.getId()] && (clearInterval(b.timers[e.getId()]), clearInterval(b.timers[e.getId()] + "audio")), o.default.error("[".concat(b.clientId, "] Subscriber connection is lost -- streamId: ").concat(e.getId(), ", p2pId: ").concat(p)), o.default.debug("[".concat(b.clientId, "] subscribe p2p failed: "), b.p2ps), c || (c = !0, n && n(V.PEERCONNECTION_FAILED), s.b.subscribe(b.joinInfo.sid, {
                                    lts: i,
                                    succ: !1,
                                    video: e.subscribeOptions && e.subscribeOptions.video,
                                    audio: e.subscribeOptions && e.subscribeOptions.audio,
                                    ...
                                    var r = !1,
                                        d = setInterval(function () {
                                            e.pc ? e.pc.getStats(function (t) {
                                                t.forEach(function (t) {
                                                    -1 !== t.id.indexOf("recv") && "audio" === t.mediaType && (parseInt(t.googDecodingNormal) > 0 || parseInt(t.audioOutputLevel) > 0) && (r || (r = !0, b.dispatchEvent({
                                                        type: "first-audio-frame-decode",
                                                        stream: e
                                                    }), clearInterval(d), s.b.reportApiInvoke(b.joinInfo.sid, {
                                        ...
                                        f = setInterval(function () {
                                            e.pc ? e.pc.getStats(function (t) {
                                                t.forEach(function (t) {
                                                    -1 === t.id.indexOf("recv") && -1 === t.id.indexOf("inbound_rtp") && -1 === t.id.indexOf("inbound-rtp") && -1 === t.id.indexOf("InboundRTP") || "video" === t.mediaType && (t.framesDecoded > 0 || t.googFramesDecoded > 0) && (u || (u = !0, b.dispatchEvent({
                                                        type: "first-video-frame-decode",
                                                        stream: e
                                                    }), clearInterval(f), e.firstFrameTime = (new Date).getTime() - e.subscribeLTS, s.b.firstRemoteFrame(b.joinInfo.sid, {
                        ...
                        } else o.default.error("[".concat(b.clientId, "] Invalid remote stream")), c || (c = !0, n && n(V.INVALID_REMOTE_STREAM), s.b.subscribe(b.joinInfo.sid, {
                            lts: i,
                            succ: !1,
                            video: e.subscribeOptions && e.subscribeOptions.video,
                            audio: e.subscribeOptions && e.subscribeOptions.audio,
                    ...
                    else o.default.error("[".concat(b.clientId, "] No such remote stream")), c || (c = !0, n && n(V.NO_SUCH_REMOTE_STREAM), s.b.subscribe(b.joinInfo.sid, {
                        lts: i,
                        succ: !1,
                        video: e.subscribeOptions && e.subscribeOptions.video,
                        audio: e.subscribeOptions && e.subscribeOptions.audio,
                        peerid: e.getId(),
                        ec: V.NO_SUCH_REMOTE_STREAM
                    }))
                    ...
                    if ("object" !== He()(e) || null === e) return o.default.error("[".concat(b.clientId, "] Invalid remote stream")), void R(n, V.INVALID_REMOTE_STREAM);
                    if (b.state !== E) return o.default.error("[".concat(b.clientId, "] User is not in the session")), void R(n, V.INVALID_OPERATION);
                    if (null != b.timers[e.getId()] && (clearInterval(b.timers[e.getId()]), clearInterval(b.timers[e.getId()] + "audio")), null != b.audioLevel[e.getId()] && delete b.audioLevel[e.getId()], null != b.timer_counter[e.getId()] && delete b.timer_counter[e.getId()], b.remoteStreams.hasOwnProperty(e.getId())) {
                        if (!b.socket) return o.default.error("[".concat(b.clientId, "] User is not in the session")), void R(n, V.INVALID_OPERATION);
                        if (e.local) return o.default.error("[".concat(b.clientId, "] Invalid remote stream")), void R(n, V.INVALID_REMOTE_STREAM);
                        e.close();
                        var i = {
                            stream_id: e.getId()
                        };
                    ...
                    } else R(n, V.NO_SUCH_REMOTE_STREAM)
                }, b.setRemoteVideoStreamType = function (e, t) {
                    if (o.default.debug("[".concat(b.clientId, "] Switching remote video stream ").concat(e.getId(), " to ").concat(t)), "object" === He()(e) && null !== e)
                        if (b.state === E) {
                            if (!e.local) {
                                switch (t) {
                    ...
                    }, t, n)) : (o.default.error("[".concat(b.clientId, "] Client is previously joined without token")), n && n(V.INVALID_PARAMETER)) : (o.default.error("[".concat(b.clientId, "] Invalid Token ").concat(e)), n && n(V.INVALID_PARAMETER))
                }, b.setStreamFallbackOption = function (e, t) {
                    if (o.default.debug("[".concat(b.clientId, "] Set stream fallback option ").concat(e.getId(), " to ").concat(t)), "object" === He()(e) && null !== e)
                        if (b.state === E) {
                            if (!e.local) {
                                switch (t) {
                    ...
                    o.default.debug("[".concat(b.clientId, "] close gateway")), b.state = h, b.socket.close(), O()
                }, b.startChannelMediaRelay = function () {
                    var e = ue()(ce.a.mark(function e(t) {
                        var n, i, a, r;
                        return ce.a.wrap(function (e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    throw new Ke.ChannelMediaError("RELAY_ALREADY_START", "", Ke.CHANNEL_MEDIA_RELAY_ERROR.RELAY_ALREADY_START);
                                case 2:
                                    return n = function (e) {
                                        b.dispatchEvent({
                                        ...
                                        e === Ke.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_FAILURE && t === Ke.CHANNEL_MEDIA_RELAY_ERROR.SERVER_CONNECTION_LOST && (b.channelMediaRelayController.dispose(), b.channelMediaRelayController = null), b.dispatchEvent({
                                            type: "channel-media-relay-state",
                                            state: e,
                                            code: t,
                                            data: n
                                        })
                                    }, b.channelMediaRelayController = new ze.a(b.joinInfo, b.clientId), b.channelMediaRelayController.on("event", n), b.channelMediaRelayController.on("state", i), e.prev = 7, e.next = 10, b.channelMediaRelayController.startChannelMediaRelay(t);
                                case 10:
                                    e.next = 22;
                                    break;
                                case 12:
                                    throw e.prev = 12, e.t0 = e.catch(7), o.default.debug("[".concat(b.clientId, "] startChannelMediaRelay exception: ").concat(JSON.stringify(e.t0))), a = Ke.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_FAILURE, r = "", r = e.t0 instanceof Ke.ChannelMediaError ? "SetSourceChannelStatus" === e.t0.data || e.t0.data && e.t0.data.serverResponse && "SetSourceChannel" === e.t0.data.serverResponse.command ? "FAILED_JOIN_SRC" : "SetDestChannelStatus" === e.t0.data || e.t0.data && e.t0.data.serverResponse && "SetDestChannel" === e.t0.data.serverResponse.command ? "FAILED_JOIN_DEST" : e.t0.data && e.t0.data.serverResponse && "StartPacketTransfer" === e.t0.data.serverResponse.command ? "FAILED_PACKET_SENT_TO_DEST" : e.t0.message === Ke.CHANNEL_MEDIA_ERROR.REQUEST_TIMEOUT || e.t0.message === Ke.CHANNEL_MEDIA_ERROR.WAIT_STATUS_TIMEOUT ? "SERVER_NO_RESPONSE" : e.t0.message === Ke.CHANNEL_MEDIA_ERROR.REQUEST_FAILED || e.t0.message === Ke.CHANNEL_MEDIA_ERROR.WAIT_STATUS_ERROR ? "SERVER_ERROR_RESPONSE" : e.t0.message === Ke.CHANNEL_MEDIA_ERROR.AP_REQUEST_TIMEOUT ? "NO_RESOURCE_AVAILABLE" : e.t0.message === Ke.CHANNEL_MEDIA_ERROR.WS_ABORT || e.t0.message === Ke.CHANNEL_MEDIA_ERROR.AP_REQUEST_ABORT ? "OPERATION_ABORT" : "INTERNAL_ERROR" : "INTERNAL_ERROR", b.dispatchEvent({
                                        type: "channel-media-relay-state",
                                        state: a,
                                        code: Ke.CHANNEL_MEDIA_RELAY_ERROR[r]
                                        ...
                                        type: "channel-media-relay-state",
                                        state: Ke.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_IDLE
                                    }), new Ke.ChannelMediaError(r, null, Ke.CHANNEL_MEDIA_RELAY_ERROR[r]);
                                case 22:
                                    b.dispatchEvent({
                                        type: "channel-media-relay-state",
                                        state: Ke.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_RUNNING,
                                        code: Ke.CHANNEL_MEDIA_RELAY_ERROR.RELAY_OK
                    ...
                    var t = ue()(ce.a.mark(function t(n) {
                        var i, a;
                        return ce.a.wrap(function (t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    ...
                                    throw new Ke.ChannelMediaError("RELAY_NOT_START", null, Ke.CHANNEL_MEDIA_RELAY_ERROR.RELAY_NOT_START);
                                case 2:
                                ...
                                case 5:
                                    ...
                                    break;
                                case 7:
                                    throw t.prev = 7, t.t0 = t.catch(2), o.default.debug("[".concat(b.clientId, "] updateChannelMediaRelay exception: ").concat(JSON.stringify(e))), i = Ke.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_FAILURE, a = "", a = e instanceof Ke.ChannelMediaError ? e.message === Ke.CHANNEL_MEDIA_ERROR.REQUEST_TIMEOUT || e.message === Ke.CHANNEL_MEDIA_ERROR.WAIT_STATUS_TIMEOUT ? "SERVER_NO_RESPONSE" : e.message === Ke.CHANNEL_MEDIA_ERROR.REQUEST_FAILED || e.message === Ke.CHANNEL_MEDIA_ERROR.WAIT_STATUS_ERROR ? "SERVER_ERROR_RESPONSE" : e.message === Ke.CHANNEL_MEDIA_ERROR.WS_ABORT || e.message === Ke.CHANNEL_MEDIA_ERROR.AP_REQUEST_ABORT ? "OPERATION_ABORT" : "INTERNAL_ERROR" : "INTERNAL_ERROR", b.dispatchEvent({
                                        type: "channel-media-relay-event",
                                        code: Ke.CHANNEL_MEDIA_RELAY_EVENT.PACKET_UPDATE_DEST_CHANNEL_REFUSED
                                    }), b.dispatchEvent({
                                        type: "channel-media-relay-state",
                                        state: i,
                                        code: Ke.CHANNEL_MEDIA_RELAY_ERROR[a]
                                    }), b.channelMediaRelayController && (b.channelMediaRelayController.dispose(), b.channelMediaConfig = null, b.channelMediaRelayController = null), b.dispatchEvent({
                                        type: "channel-media-relay-state",
                                        state: Ke.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_IDLE
                                    }), new Ke.ChannelMediaError(a, null, Ke.CHANNEL_MEDIA_RELAY_ERROR[a]);
                                case 18:
                ...
                }(), b.stopChannelMediaRelay = ue()(ce.a.mark(function t() {
                    var n, i;
                    return ce.a.wrap(function (t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                            ...
                            case 5:
                                ...
                                break;
                            case 7:
                                throw t.prev = 7, t.t0 = t.catch(2), o.default.debug("[".concat(b.clientId, "] stopChannelMediaRelay exception: ").concat(JSON.stringify(e))), n = Ke.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_FAILURE, i = "", i = e instanceof Ke.ChannelMediaError ? e.message === Ke.CHANNEL_MEDIA_ERROR.REQUEST_TIMEOUT || e.message === Ke.CHANNEL_MEDIA_ERROR.WAIT_STATUS_TIMEOUT ? "SERVER_NO_RESPONSE" : e.message === Ke.CHANNEL_MEDIA_ERROR.REQUEST_FAILED || e.message === Ke.CHANNEL_MEDIA_ERROR.WAIT_STATUS_ERROR ? "SERVER_ERROR_RESPONSE" : "INTERNAL_ERROR" : "INTERNAL_ERROR", b.dispatchEvent({
                                    type: "channel-media-relay-state",
                                    state: n,
                                    code: Ke.CHANNEL_MEDIA_RELAY_ERROR[i]
                                }), b.channelMediaRelayController && (b.channelMediaRelayController.dispose(), b.channelMediaConfig = null, b.channelMediaRelayController = null), b.dispatchEvent({
                                    type: "channel-media-relay-state",
                                    state: Ke.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_IDLE
                                }), new Ke.ChannelMediaError(i, null, Ke.CHANNEL_MEDIA_RELAY_ERROR[i]);
                            case 17:
                ...
                var A = function () {
                    o.default.debug("[".concat(b.clientId, "] Reconnect gateway")), b.state = h, b.socket.close(), O(), b.reconnectMode = "recover", b.state = _, C()
                };
                b.recover = A;
                var O = function () {
                ...
                var C = function (e, t) {
                    ...
                    N = function (e, t, n) {
                        if (b.onConnect = t, b.socket) {
                        ...
                        } else c = e.gatewayAddr, b.socket = at(c, {
                            sid: b.joinInfo.sid,
                            clientId: b.clientId
                            ...
                            b.state = _, o.default.debug("[".concat(b.clientId, "] Try to reconnect choose server and get gateway list again ")), b.reconnectingCS = !0, b.leaveOnConnected = null;
                            var e = b.joinInfo && b.joinInfo.sid;
                            ft(b.joinInfo, function (t) {
                            ...
                            if (o.default.debug("[".concat(b.clientId, "] Receive disconnect message")), b.state !== h) {
                                b.state = h;
                                var t = u({
                                    type: "error",
                                    reason: V.SOCKET_DISCONNECTED
                                });
                                if (b.dispatchEvent(t), 0 === b.p2ps.size ? b.reconnectMode = "tryNext" : b.reconnectMode = "retry", O(), b.channelMediaRelayController && b.channelMediaRelayController.dispose(), b.channelMediaRelayController = null, 1 != i) {
                                    ...
                                    if (o.default.error("[".concat(b.clientId, "] Disconnect from server [").concat(JSON.stringify(e), "], attempt to recover [#").concat(b.attemps, "] after ").concat(a / 1e3, " seconds")), b.hasInvokeLeave) return o.default.debug("[".concat(b.clientId, "] No reconnection becase client.leave has been invoked")), void(b.hasInvokeLeave = !1);
                                    setTimeout(function () {
                            ...
                            var t = l({
                                ...
                                n = b.remoteStreams[e.uid];
                                b.dispatchEvent(t),
                            n ? (n.peerMuteAudio = !1, n.pc && b._adjustPCMuteStatus(n)) : o.default.debug("Ignoring event ".concat(e.type), e)
                            ...
                            "tryNext" === e ? function (e, t) {
                                o.default.debug("[".concat(b.clientId, "] Connect next gateway")), b.state = h, b.socket.close(), O(), b.reconnectMode = "tryNext", C(e, t)
                            }(t, n) : "retry" === e ? function (e, t) {
                                o.default.debug("[".concat(b.clientId, "] Reconnect gateway")), b.state = h, b.socket.close(), O(), b.reconnectMode = "retry", C(e, t)
                            }(t, n) : "quit" === e ? (o.default.debug("[".concat(b.clientId, "] quit gateway")), b.state = h, b.socket.close(), O()) : "recover" === e && A()
                        }, b.socket.on("on_notification", function (e) {
                            if (o.default.debug("[".concat(b.clientId, "] Receive notification: "), e), "ERR_JOIN_BY_MULTI_IP" === y[e.code]) return b.dispatchEvent({
                                type: "onMultiIP",
                                option: e.option
                            });
                            e.detail ? b._doWithAction(vt[y[e.code]]) : e.action && b._doWithAction(e.action)
        ...
        Tt.DISCONNECTED = 0, Tt.CONNECTING = 1, Tt.CONNECTED = 2, Tt.DISCONNECTING = 3, Tt.connetionStateMap = {
            0: "DISCONNECTED",
            1: "CONNECTING",
            2: "CONNECTED",
            3: "DISCONNECTING"
        ...
        var Rt = Tt,
                        ...
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return n = t.uid, i = t.url, a = t.serviceName, s = t.sid, c = t.appId, d = t.cname, u = t.timeout, e.abrupt("return", new Promise(function (e, t) {
                                    ...
                                    p.open("POST", i, !0), p.setRequestHeader("Content-Type", "application/json; charset=utf-8"), p.setRequestHeader("X-Packet-Service-Type", "0"), p.setRequestHeader("X-Packet-URI", "61"), p.onload = function () {
                                        if (!l) {
                                            var n = null,
                                                i = null;
                                            try {
                                    ...
                                    }, u && (p.timeout = u), p.send(JSON.stringify({
                                        service_name: a,
            ...
            Ft = function () {
                var e = ue()(ce.a.mark(function e(t) {
                    var n, i, a, s, c, d, u, l, p, f, m, g;
                    return ce.a.wrap(function (e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                n = t.serviceName, i = t.sid, a = t.appId, s = t.cname, c = t.uid, d = null, e.t0 = ce.a.keys(Object(r.getParameter)("UAP_AP"));
                            case 3:
                                if ((e.t1 = e.t0()).done) {
                                    e.next = 34;
                                    break
                                }
                                return u = e.t1.value, l = "https://".concat(Object(r.getParameter)("UAP_AP")[u], "/api/v1?action=uap"), p = void 0, e.prev = 7, e.next = 10, jt({
                                    uid: c,
                                    url: l,
                                    appId: a,
                                    sid: i,
                            ...
                            case 18:
                                f = ce.a.mark(function e(t) {
                                    var i, a, r;
                                    return ce.a.wrap(function (e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                if (i = p.servers[t], a = "wss://".concat(i.address.replace(/\./g, "-"), ".edge.").concat(t % 2 == 0 ? "agora.io" : "agoraio.cn", ":").concat(i.wss, "?serviceName=").concat(encodeURIComponent(n)), i.wss) {
                                                    e.next = 5;
                                                    break
                                                }
                                            ...
                                            case 8:
                                                return (r = e.sent).workerToken = p.workerToken, e.abrupt("return", {
                                                    v: r
                                                });
                                            case 13:
                            ...
                            case 20:
                                if (!(m < p.servers.length)) {
                                    e.next = 32;
                                    break
                                }
                                return e.delegateYield(f(m), "t3", 22);
                            case 22:
            ...
            Wt = {},
            Gt = function (e) {
                return Wt[e] ? (Wt[e] += 1, Wt[e]) : (Wt[e] = 1, Wt[e])
            },
            qt = function (e) {
                var t = e.appId,
                    n = e.cname,
                    ...
                    a = e.sid,
                    s = c();
                return s.status = Mt, s.pingpongTimer = null, s.connection = null, s.requests = [], s.appId = t, s.cname = n, s.uid = i, s.sid = a, s.connection = null, s.connectionId = Ut++, s.connect = function () {
                    var e = ue()(ce.a.mark(function e(t) {
                        var n;
                        return ce.a.wrap(function (e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    if (n = t.wsClient, s.status === Mt) {
                                        e.next = 4;
                                        break
                                    }
                                    return o.default.debug("Ignored UapConnection.connect: ".concat(s.status)), e.abrupt("return");
                                case 4:
                                    s.connection = n, s.status = Lt, s._flush(), s.startPingpong(), n.addEventListener("close", function (e) {
                ...
                }(), s.disconnect = ue()(ce.a.mark(function e() {
                    var t;
                    return ce.a.wrap(function (e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                for (t in s.status = kt, clearInterval(s.pingpongTimer), s.pingpongTimer = null, s.requests) s.requests[t].promises.reject("DISCONNECTED");
                                return s.requests = [], null, s.connection && (s.connection.close(), s.connection = null), s.status = Dt, e.abrupt("return", null);
                            case 9:
                            case "end":
                                return e.stop()
                        }
                    ...
                    var e = ue()(ce.a.mark(function e(t) {
                        ...
                        return ce.a.wrap(function (e) {
                            for (;;) switch (e.prev = e.next) {
                                ...
                                case 11:
                                    if (s.status !== kt || t.clientRequest && "DestroyWorker" === t.clientRequest.command) {
                                        e.next = 17;
                                        break
                                    }
                    ...
                    s.connection && s.status === Lt && s.requests.forEach(function (e) {
                    ...
                    clearInterval(s.pingpongTimer), s.pingpongTimer = setInterval(ue()(ce.a.mark(function e() {
                        return ce.a.wrap(function (e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    if (s.status !== Lt || !s.connection || 1 !== s.connection.readyState) {
                                        e.next = 9;
                                        break
                                    }
                ...
                }, s._flush(), s.startPingpong(), Pt.push(s), s
            },
            Yt = function (e) {
                e.disconnect();
        ...
        var Kt = function (e) {
            ...
            Xt = function (e) {
                ...
                }, t.useProxyServer = !1, t.mode = e.mode, t.codec = e.codec, t.clientId = Object(ne.generateSessionId)().slice(0, 5), t.uintUid = null;
                e = S()({}, e);
                return t.aespassword = null, t.aesmode = "none", t.hasPublished = !1, t.getSessionId = function () {
                        ...
                        if (!(n instanceof Ke.ChannelMediaRelayConfiguration)) throw "Configration should be instance of [ChannelMediaRelayConfiguration]";
                        var r = n.getSrcChannelMediaInfo(),
                            o = n.getDestChannelMediaInfos();
                        if (Object(re.isEmpty)(r)) throw "srcChannelMediaInfo should not be empty";
                        if (Object(re.isEmpty)(o) || 0 === o.length) throw "destChannelMediaInfos should not be empty";
                        if (!Object(ne.is32Uint)(r.uid)) throw "Invalid uid in srcChannelMediaInfo";
                        if (!Object(re.isValidChannelName)(r.channelName)) throw "Invalid channelName in srcChannelMediaInfo";
                        if (r.token && !Object(re.isValidToken)(r.token)) throw "Invalid token in srcChannelMediaInfo";
                        if (o.forEach(function (e) {
                                if (!Object(ne.is32Uint)(e.uid)) throw "Invalid uid in destChannelMediaInfo";
                                if (!Object(re.isValidChannelName)(e.channelName)) throw "Invalid channelName in destChannelMediaInfo";
                                if (e.token && !Object(re.isValidToken)(e.token)) throw "Invalid token in destChannelMediaInfo"
                            }), t.gatewayClient.state !== Rt.CONNECTED) throw "startChannelMediaRelay should be used after join";
                        ...
                        if (o.forEach(function (e) {
                                ...
                                if (!Object(re.isValidChannelName)(e.channelName)) throw "Invalid channelName in destChannelMediaInfo";
                                if (e.token && !Object(re.isValidToken)(e.token)) throw "Invalid token in destChannelMediaInfo"
                            }), t.gatewayClient.state !== Rt.CONNECTED) throw "updateChannelMediaRelay should be used after join";
                        ...
                        var n = s.b.reportApiInvoke(e.sessionId, {
                            ...
                            i = Rt.connetionStateMap[t.gatewayClient.state];
                        return n(), i
                        ...
                        if (Object(re.checkValidEnum)(n, "setClientRole", ["host", "audience"]), "rtc" === t.mode) {
                            var r = "RTC mode can not use setClientRole";
                            return o.default.warning("[".concat(t.clientId, "] ").concat(r)), a && a(r)
                        }
                        t.gatewayClient && t.gatewayClient.state === Rt.CONNECTED ? ("audience" === n && (0 === this.highStreamState ? this._unpublish(this.highStream, function () {
                            a && a(null, {
                                role: n
                            })
                        }, function (e) {
                        ...
                        if (t.gatewayClient.state !== Rt.CONNECTED) {
                        ...
                        if (!Object(re.isValidToken)(n)) throw new Error("Invalid token: Token is of the string type .Length of the string: [1,255]. ASCII characters only.");
                        return t.gatewayClient ? t.key ? (t.key = n, void t.gatewayClient.renewToken(n, function (e) {
                            return r(null, e)
                        }, r)) : (o.default.error("[".concat(t.clientId, "] renewToken should not be called before user join")), r(V.INVALID_OPERATION)) : (o.default.error("[".concat(t.clientId, "] renewToken Failed. GatewayClient not Exist")), r(V.INVALID_OPERATION))
                        ...
                        Object(re.checkValidObject)(n, "param");
                        var a = n.width,
                            r = n.height,
                            c = n.framerate,
                            d = n.bitrate;
                        ...
                        Object(re.checkValidString)(n), Object(m.isChromeKernel)() && Object(m.getChromeKernelVersion)() <= 48 ? a ? r(V.BAD_ENVIRONMENT) : Object(ne.popBanTip)() : (o.default.info("[".concat(t.clientId, "] Initializing AgoraRTC client, appId: ").concat(n, ".")), e.appId = n, e.sessionId = Object(ne.generateSessionId)(), r())
                        ...
                        if (t.gatewayClient && t.gatewayClient.state !== Rt.DISCONNECTED) throw new Error("Set turn server before join channel");
                        if (t.useProxyServer) throw new Error("You have already set the proxy");
                        Object(re.checkValidObject)(n, "turnServer");
                        var a = n.turnServerURL,
                            ...
                            u = n.forceturn,
                            l = n.tcpport;
                        Object(re.checkValidString)(a, "turnServerURL"), Object(re.checkValidString)(r, "username"), Object(re.checkValidString)(c, "password"), Object(re.checkValidString)(d, "udpport"), Object(re.isEmpty)(u) || Object(re.checkValidBoolean)(u, "forceturn"), t.turnServer.mode = "manual", t.turnServer.url = a, t.turnServer.udpport = d, t.turnServer.username = r, t.turnServer.credential = c, t.turnServer.forceturn = u || !1, Object(re.isEmpty)(l) || (Object(re.checkValidString)(l, "tcpport"), t.turnServer.tcpport = l, o.default.info("[".concat(t.clientId, "] Set turnserver tcpurl. ").concat(t.turnServer.url, ":").concat(t.turnServer.tcpport))), o.default.info("[".concat(t.clientId, "] Set turnserver udpurl. ").concat(t.turnServer.url, ":").concat(t.turnServer.udpport, ",username: ").concat(t.turnServer.uername, ",password: ").concat(t.turnServer.credential)), i()
                        ...
                        if (t.gatewayClient && t.gatewayClient.state !== Rt.DISCONNECTED) throw new Error("Set proxy server before join channel");
                        if (!n) throw new Error("Do not set the proxyServer parameter as empty");
                        if (t.useProxyServer) throw new Error("You have already set the proxy");
                        Object(re.checkValidString)(n, "proxyServer"), t.proxyServer = n, s.b.setProxyServer(n), o.default.setProxyServer(n), i()
                        ...
                        if (t.gatewayClient && t.gatewayClient.state !== Rt.DISCONNECTED) throw new Error("Start proxy server before join channel");
                        ...
                        if (t.gatewayClient && t.gatewayClient.state !== Rt.DISCONNECTED) throw new Error("Stop proxy server after leave channel");
                        ...
                        Object(re.checkValidString)(n, "password"), t.aespassword = n, i()
                        ...
                        if (Object(re.checkValidString)(n, "encryptionMode"), -1 === $e.indexOf(n)) throw new Error('Invalid encryptionMode: encryptionMode should be "aes-128-xts" | "aes-256-xts" | "aes-128-ecb"');
                        t.aesmode = n, i()
                        ...
                        Object(re.checkValidObject)(n, "config");
                        var a = n.width,
                            r = n.height,
                            o = n.framerate,
                            c = n.bitrate,
                            d = n.publisherUrl;
                        Object(re.checkValidNumber)(a, "width"), Object(re.checkValidNumber)(r, "height"), Object(re.checkValidNumber)(o, "framerate"), Object(re.checkValidNumber)(c, "bitrate", 1, 1e7), d && Object(re.checkValidString)(d, "publisherUrl"), t.gatewayClient.configPublisher(n), i()
                        ...
                        return "iOS" === Object(m.getBrowserOS)() ? (s.b.streamSwitch(e.sessionId, {
                            ...
                            isdual: !0,
                            succ: !1
                        }), a(V.IOS_NOT_SUPPORT)) : Object(m.isWeChatBrowser)() ? (s.b.streamSwitch(e.sessionId, {
                            lts: (new Date).getTime(),
                            isdual: !0,
                            succ: !1
                        }), a(V.WECHAT_NOT_SUPPORT)) : (s.b.streamSwitch(e.sessionId, {
                            lts: (new Date).getTime(),
                            isdual: !0,
                            succ: !0
                            ...
                            o.default.warning("[".concat(t.clientId, "]"), e), a(V.ENABLE_DUALSTREAM_FAILED)
                        }) : 1 === t.highStreamState ? a(V.STILL_ON_PUBLISHING) : a(null)))
                        ...
                        s.b.streamSwitch(e.sessionId, {
                            ...
                            o.default.warning("[".concat(t.clientId, "]"), e), a(V.DISABLE_DUALSTREAM_FAILED)
                        }) : 1 === t.highStreamState ? a(V.STILL_ON_PUBLISHING) : a()
                        ...
                        if (t.highStream && t.highStream.stream) {
                            ...
                            if (i.streamID += 1, i.audio = !1, i.video) {
                                ...
                                a ? ae.getVideoCameraIdByLabel(a.label, function (a) {
                                    ...
                                    } else s.setVideoProfileCustom(At(t.highStream.profile));
                                    s.init(function () {
                                        t.highStream.lowStream = s, t.highStream.userMuteVideo && s.muteVideo(), e && e(s)
                                    }, n)
                                }, n) : n && n(V.HIGH_STREAM_NOT_VIDEO_TRACE)
                        ...
                        return 2 !== t.lowStreamState ? n && n(V.LOW_STREAM_ALREADY_PUBLISHED) : t.highStream && t.highStream.hasScreen() ? n && n(V.SHARING_SCREEN_NOT_SUPPORT) : void t._getLowStream(function (i) {
                        ...
                        if (0 !== t.lowStreamState) return n && n(V.LOW_STREAM_NOT_YET_PUBLISHED);
                        ...
                        if (n && !Object(re.isValidToken)(n)) return o.default.warning("[".concat(t.clientId, "] Param channelKey should be string")), d(V.INVALID_PARAMETER);
                        if (!Object(re.isValidChannelName)(i)) return o.default.error("Invalid Channel Name ".concat(i)), o.default.warning("[".concat(t.clientId, "] The length must be within 64 bytes. The supported characters: a-z,A-Z,0-9,space,!, #, $, %, &, (, ), +, -, :, ;, <, =, ., >, ?, @, [, ], ^, _,  {, }, |, ~, ,")), d(V.INVALID_PARAMETER);
                        if ("string" == typeof i && "" === i) return o.default.warning("[".concat(t.clientId, "] Param channel should not be empty")), d(V.INVALID_PARAMETER);
                        if (a && !Object(ne.is32Uint)(a) && !Object(re.isValidString)(a, 1, 255)) return o.default.error("Invalid UID ".concat(a, " ").concat(He()(a))), o.default.warning("[".concat(t.clientId, "] [String uid] Length of the string: [1,255]. ASCII characters only. [Number uid] The value range is [0,10000]")), d(V.INVALID_PARAMETER);
                        if ("string" == typeof a && 0 == a.length) return o.default.warning("[".concat(t.clientId, "] String uid should not be empty")), d(V.INVALID_PARAMETER);
                        if ("string" == typeof a && a.length > 256) return o.default.warning("[".concat(t.clientId, "] Length of string uid should be less than 255")), d(V.INVALID_PARAMETER);
                        ...
                        if ("string" == typeof a && (u.stringUid = a, t.uintUid ? (u.uid = t.uintUid, delete t.uintUid) : u.uid = 0), t.aespassword && "none" !== t.aesmode && S()(u, {
                                ...
                                return d(e)
                            }, t.channel = i, t.gatewayClient.state !== Rt.DISCONNECTED) return o.default.error("[".concat(t.clientId, "] Client already in connecting/connected state")), d(V.INVALID_OPERATION), void s.b.joinGateway(e.sessionId, {
                            lts: Date.now(),
                            succ: !1,
                            ec: V.INVALID_OPERATION,
                            addr: null
                        });
                        t.gatewayClient.state = Rt.CONNECTING;
                        var l = function (a, r) {
                        ...
                        u.stringUid && !u.uid ? (t.userAccountReq && !t.userAccountReq.isFinished() && t.userAccountReq.cancel(), t.userAccountReq = gt(u, t.gatewayClient), t.userAccountReq.then(function (e) {
                            o.default.debug("getUserAccount Success ".concat(e.url, " ").concat(u.stringUid, " => ").concat(e.uid)), u.uid = e.uid, ft(u, l, function (e) {
                                return d(e)
                            })
                        }).catch(function (e) {
                        ...
                        Object(re.checkValidString)(n, "key", 1, 2047), void 0 === t.key ? (o.default.error("[".concat(t.clientId, "] renewChannelKey should not be called before user join")), r(V.INVALID_OPERATION)) : (t.key = n, t.gatewayClient.joinInfo.token = n, t.gatewayClient.key = n, t.gatewayClient.recover(), r())
                        ...
                        var a = !1,
                            c = s.b.reportApiInvoke(e.sessionId, {
                                callback: function (e, a) {
                                    if (e) return i && i(e);
                                    var r;
                                    t.gatewayClient.reconnectingCS = !1, clearTimeout((r = t.clientId, ut[r])), t._renewSession(), t.rtcStatsCollector.clearNetworkQualityTimer(), n && n(a)
                                },
                                name: "Client.leave",
                                options: arguments,
                                tag: "tracer"
                            });
                        o.default.info("[".concat(t.clientId, "] Leaving channel")), t.userAccountReq && !t.userAccountReq.isFinished() && (t.userAccountReq.cancel(), t.gatewayClient.state === Rt.CONNECTING && (t.gatewayClient.state = Rt.DISCONNECTED)), t.gatewayClient.leave(function (e) {
                            a = !0, c(null, e)
                        }, c), setTimeout(function () {
                            a || (t.gatewayClient.socket && (t.gatewayClient.socket.close(), t.gatewayClient.socket = null), t.gatewayClient.state = Rt.DISCONNECTED, c(null, "LEAVE_MSG_TIMEOUT"))
                        }, Object(r.getParameter)("LEAVE_MSG_TIMEOUT"))
                    }, t._renewSession = function () {
                        var n = Object(ne.generateSessionId)();
                        ...
                        if (2 !== t.highStreamState) return o.default.warning("[".concat(t.clientId, "] Can't publish stream when stream already publish ").concat(n.getId())), a && a(V.STREAM_ALREADY_PUBLISHED);
                        ...
                        var c = function (n, i, a) {
                            t.gatewayClient.publish(n, {
                                ...
                                n.sid = e.sessionId, t.highStreamState = 0, o.default.info("[".concat(t.clientId, "] Publish success, uid: ").concat(n.getId())), t.highStream && (t.highStream.isDualStream = t.isDualStream), t.isDualStream ? t._publishLowStream(function () {
                                    ...
                                    o.default.warning("[".concat(t.clientId, "] "), e), Fe.replaceWithCanvasTrack(n), i && i()
                                }) : (Fe.replaceWithCanvasTrack(n), i && i())
                            }, a)
                        };
                        ...
                        if (0 !== t.highStreamState) return o.default.warning("[".concat(t.clientId, "] Can't unpublish stream when stream not publish")), i && i(V.STREAM_NOT_YET_PUBLISHED);
                        ...
                        2 === t.highStreamState ? n._hasVideoTracks() || n._hasAudioTracks() ? t._publish(n, function (e) {
                            ...
                            return a(e)
                        }) : a(V.NO_TRACK_IN_STREAM) : a(V.STREAM_ALREADY_PUBLISHED)
                        ...
                        "function" == typeof i && (a = i, i = null), Object(re.checkValidObject)(n, "stream"), Object(re.isEmpty)(i) || (Object(re.checkValidObject)(i, "options"), Object(re.isEmpty)(i.video) || Object(re.checkValidBoolean)(i.video, "options.video"), Object(re.isEmpty)(i.audio) || Object(re.checkValidBoolean)(i.audio, "options.audio"));
                        var c = {
                            video: !0,
                            audio: !0
                        };
                        if (!Object(re.isEmpty)(i)) {
                            ...
                            if (!Object(re.isEmpty)(i.video) && !Object(re.isValidBoolean)(i.video) || !Object(re.isEmpty)(i.audio) && !Object(re.isValidBoolean)(i.audio) || !1 === i.audio && !1 === i.video) {
                        ...
                        n.subscribeOptions ? (S()(n.subscribeOptions, c, i), t.gatewayClient.subscribeChange(n, function (e) {
                            return r(null, e)
                        }, r)) : (n.subscribeOptions = S()({}, c, i), t.gatewayClient.subscribe(n, function (e) {
                            return r(null, e)
                        }, r))
                        ...
                        Object(re.checkValidEnum)(i, "streamType", [0, 1]), t.gatewayClient.setRemoteVideoStreamType(n, i), a()
                        ...
                        Object(re.checkValidEnum)(i, "fallbackType", [0, 1, 2]), t.gatewayClient.setStreamFallbackOption(n, i), a()
                        ...
                        n = n || 2e3, i = i || 3, Object(re.checkValidNumber)(i, "smooth", 1, 100), Object(re.checkValidNumber)(n, "interval", 50, 1e5), t.audioVolumeIndication = t.audioVolumeIndication || {
                            enabled: !0
                        ...
                        return o.default.deprecate("[".concat(t.clientId, "] client.getNetworkStats is deprecated. Use client.getTransportStats instead.")), wt.getStats(e, n)
                    }, t.getSystemStats = function (e, t) {
                        return v.getStats(e, t)
                    }, t.getRecordingDevices = function (e, t) {
                        return ae.getRecordingDevices(e, t)
                    }, t.getPlayoutDevices = function (e, t) {
                        return ae.getPlayoutDevices(e, t)
                    }, t.getCameras = function (e, t) {
                        return ae.getCameras(e, t)
                    ...
                    }, e.clientId = t.clientId, t.gatewayClient = Rt(e), t.listenerLoggerTimer = null, t.listenerLoggerCache = [], t.on = function (e, n) {
                        ...
                        var t = c();
                        return t.gatewayClient = e, t.exceptionMonitor = new Nt(e), t.localStats = {}, t.remoteStats = {}, t.session = {
                            sendBytes: 0,
                            recvBytes: 0,
                            WSSendBytes: 0,
                            WSSendBytesDelta: 0,
                            ...
                            for (var i in t.remoteStats) {
                                var a = {},
                                    r = t.remoteStats[i];
                                ie(a, "videoReceiveDelay", r.videoStats && r.videoStats.googCurrentDelayMs), ie(a, "VideoFreezeRate", r.videoStats && r.videoStats.videoFreezeRate), ie(a, "FirstFrameTime", r.firstFrameTime), n[i] = a
                            }
                            e && e(n)
                            ...
                            for (var i in t.remoteStats) {
                                var a = {},
                                    r = t.remoteStats[i];
                                ie(a, "audioReceiveDelay", r.audioStats && r.audioStats.googCurrentDelayMs), ie(a, "AudioFreezeRate", r.videoStats && r.videoStats.videoFreezeRate), n[i] = a
                            }
                            e && e(n)
                            ...
                            var n = {},
                                ...
                                r = a.peer_delay;
                            if (ie(n, "OutgoingAvailableBandwidth", t.gatewayClient.OutgoingAvailableBandwidth / 1e3), ie(n, "RTT", a && a.access_delay), r) {
                                var o = !0,
                                    s = !1,
                                    c = void 0;
                                try {
                            ...
                            var d = r + t.session.WSSendBytesDelta + t.session.HTTPSendBytesDelta,
                                ...
                                l = t.session.sendBytes + Object(nt.getHTTPSendBytes)(),
                                p = t.session.recvBytes + Object(nt.getHTTPRecvBytes)();
                            t.gatewayClient.socket && t.gatewayClient.socket.state === t.gatewayClient.CONNECTED && (l += a.getSendBytes(), p += a.getRecvBytes());
                            var f = 1;
                            i.peer_delay && (f = i.peer_delay.length, f += 1), ie(n, "Duration", a.getDuration()), ie(n, "UserCount", f), ie(n, "SendBytes", l), ie(n, "RecvBytes", p), ie(n, "SendBitrate", 8 * d / 1e3), ie(n, "RecvBitrate", 8 * u / 1e3), e && e(n)
                            ...
                            t.clearNetworkQualityTimer(), t.networkQualityTimer = setInterval(function () {
                                if (t.gatewayClient.state !== Rt.CONNECTED) t.gatewayClient.dispatchEvent({
                            ...
                            if (Object.keys(t.gatewayClient.localStreams).forEach(function (e) {
                                ...
                                }), t.localStats = a, t.session.HTTPSendBytesDelta = Object(nt.getHTTPSendBytes)() - t.session.HTTPSendBytes, t.session.HTTPSendBytes = Object(nt.getHTTPSendBytes)(), t.session.HTTPRecvBytesDelta = Object(nt.getHTTPRecvBytes)() - t.session.HTTPRecvBytes, t.session.HTTPRecvBytes = Object(nt.getHTTPRecvBytes)(), t.gatewayClient.socket && t.gatewayClient.socket.state === t.gatewayClient.CONNECTED) {
                        ...
                        return t.client = e, t.client.gatewayClient && t.client.gatewayClient.on("config-distribute", function (n) {
                            var i = n.joinInfo,
                                a = n.config;
                            if (a) {
                                Object(re.isEmpty)(a.uploadLog) || (Object(r.setParameter)("UPLOAD_LOG", a.uploadLog), s.b.reportApiInvoke(i.sid, {
                                    name: "_configDistribute",
                                    options: {
                                        feature: "uploadLog",
                                        value: a.uploadLog
                                    }
                                })()), Object(re.isEmpty)(a.dualStream) || (e.isDualStream = a.dualStream, s.b.reportApiInvoke(i.sid, {
                                    name: "_configDistribute",
                                    options: {
                                        feature: "dualStream",
                                        value: a.dualStream
                                    }
                                })()), Object(re.isEmpty)(a.streamFallbackOption) || t.client.gatewayClient && t.client.gatewayClient.on("stream-subscribed", function (e) {
                                    var n = e.stream;
                    ...
                    function (e, t) {
                        ...
                        e.liveStreaming = c(), e.liveStreaming.connections = {
                        ...
                        }), e.liveStreaming.connect = (m = ue()(ce.a.mark(function n(i) {
                            var a, r;
                                ...
                                for (;;) switch (n.prev = n.next) {
                                    ...
                                    case 3:
                                        return a = new qt({
                                            ...
                                            sid: t.sessionId,
                                            uid: e.joinInfo.uid
                                        }), e.liveStreaming.connections[i] = a, n.next = 7, Ft({
                                            appId: t.appId,
                                            cname: e.channel,
                                            serviceName: i,
                                            sid: t.sessionId,
                                    ...
                                    case 10:
                                        return a.on("notification", function (t) {
                                            ...
                                            Yt(a), o.default.debug("Reconnect ".concat(i)), e.liveStreaming.connect(i).catch(function (t) {
                        ...
                        }), e.liveStreaming.disconnect = (f = ue()(ce.a.mark(function t(n) {
                            var i, a;
                            return ce.a.wrap(function (t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        t.t0 = ce.a.keys(e.liveStreaming.connections);
                                    case 1:
                                        if ((t.t1 = t.t0()).done) {
                                            t.next = 13;
                                            break
                        ...
                        }), e.liveStreaming.resumeStates = (p = ue()(ce.a.mark(function t(n) {
                            var i, a, r, s, c, d, u, l;
                            return ce.a.wrap(function (t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                    ...
                                    case 5:
                                        ...
                                        break;
                                    case 8:
                                        t.t2 = ce.a.keys(e.liveStreaming.pushStates);
                                    case 9:
                                        if ((t.t3 = t.t2()).done) {
                                            t.next = 37;
                                            break
                                    ...
                                    case 35:
                                        ...
                                        break;
                                    case 37:
                                        t.t5 = ce.a.keys(e.liveStreaming.pullStates);
                                    case 38:
                                        if ((t.t6 = t.t5()).done) {
                                            t.next = 62;
                                            break
                            ...
                            Object(re.isEmpty)(i) || Object(re.checkValidBoolean)(i, "transcodingEnabled"), Object(re.checkValidString)(n, "url", 1, 1024);
                        ...
                        }, e._startLiveStreaming = (l = ue()(ce.a.mark(function n(i, a) {
                            var r, s, c, d;
                            return ce.a.wrap(function (n) {
                                for (;;) switch (n.prev = n.next) {
                                    case 0:
                                        return r = S()({
                                            ...
                                            command: "request"
                                        }), o.default.debug("startLiveStreaming ".concat(i, ", ").concat(a)), S()(r.clientRequest, e.liveStreaming.startOptions, {
                                            ts: Date.now(),
                                            url: i,
                            ...
                            o.default.debug("setLiveTranscoding: ".concat(JSON.stringify(n))), Object(re.checkValidObject)(n, "transcoding");
                            var a = n,
                                r = a.width,
                                c = a.height,
                                d = a.videoBitrate,
                            ...
                            if ((n = JSON.parse(JSON.stringify(n))).transcodingUsers && (n.userConfigs = n.transcodingUsers, delete n.transcodingUsers), e.joinInfo.stringUid && n.userConfigs && n.userConfigs.length) {
                                ...
                                n.userConfigs.forEach(function (t) {
                                    y.push(gt(e.joinInfo, e.gatewayClient, t.uid).then(function (e) {
                                        t.uid = e.uid
                                    }))
                                });
                                var T = Promise.all(y).then(function () {
                        ...
                        }, e._setLiveTranscoding = (u = ue()(ce.a.mark(function t(n, i) {
                            var a, r, o;
                            return ce.a.wrap(function (t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                            ...
                            Object(re.checkValidString)(n, "url", 1, 1024);
                            var a = s.b.reportApiInvoke(t.sessionId, {
                        ...
                        }, e._stopLiveStreaming = (d = ue()(ce.a.mark(function t(n, i, a) {
                            var r, o, s, c, d, u;
                            return ce.a.wrap(function (t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                        ...
                        }, e._addInjectStreamUrl = (r = ue()(ce.a.mark(function n(i, a) {
                            var r, o, s, c, d;
                            return ce.a.wrap(function (n) {
                                for (;;) switch (n.prev = n.next) {
                                    case 0:
                        ...
                        }), e.removeInjectStreamUrl = (a = ue()(ce.a.mark(function n(i) {
                            var a, r, o = arguments;
                            return ce.a.wrap(function (n) {
                                for (;;) switch (n.prev = n.next) {
                                    case 0:
                                        return Object(re.checkValidString)(i, "url", 1, 255), a = s.b.reportApiInvoke(t.sessionId, {
                        ...
                        }), e._removeInjectStreamUrl = (i = ue()(ce.a.mark(function t(n) {
                            var i, a, r, o;
                            return ce.a.wrap(function (t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                        ...
                        var f;
                        var m
                    }(t, e), Object(re.isEmpty)(e.turnServer) || t.setTurnServer(e.turnServer), Object(re.isEmpty)(e.proxyServer) || t.setProxyServer(e.proxyServer), "live" === t.mode && (t.gatewayClient.role = "audience"), "rtc" === t.mode && (t.gatewayClient.role = "host"), t.gatewayClient.on("onMultiIP", function (e) {
                        t.gatewayClient.closeGateway(), t.gatewayClient.socket = void 0, t.gatewayClient.hasChangeBGPAddress = !0, t.joinInfo.multiIP = e.option, t.gatewayClient.state = Rt.CONNECTING;
                        var n = function (e) {
                        ...
                        t.joinInfo.stringUid && !t.joinInfo.uid ? (t.userAccountReq && !t.userAccountReq.isFinished() && t.userAccountReq.cancel(), t.userAccountReq = gt(joinInfo, t.gatewayClient), t.userAccountReq.then(function (e) {
                            o.default.error("getUserAccount Success ".concat(e.url, " ").concat(joinInfo.stringUid, " => ").concat(e.uid)), t.joinInfo.uid = e.uid, ft(t.joinInfo, n, t.onFailure)
                        }).catch(function (e) {
                            o.default.error("getUserAccount rejected", e), t.onFailure(e)
                        })) : ft(t.joinInfo, n, t.onFailure)
            ...
            $t = ae.getDevices,
            Zt = X,
            en = JSON.parse(JSON.stringify(r.SUPPORT_RESOLUTION_LIST));
        n.default = {
            TranscodingUser: {
                uid: 0,
                x: 0,
            ...
            createClient: function (e) {
                ...
                var n = function (e) {
                    return -1 === Xe.indexOf(e.mode) ? V.INVALID_CLIENT_MODE : -1 === Qe.indexOf(e.codec) ? V.INVALID_CLIENT_CODEC : "h264_interop" == e.mode && "h264" !== e.codec && V.CLIENT_MODE_CODEC_MISMATCH
                }(e);
            ...
            createStream: function (e) {
                ...
                Object(re.checkValidObject)(e, "StreamSpec");
                var n = e.streamID,
                    i = e.audio,
                    a = e.video,
                    r = e.screen,
                    ...
                    m = e.mediaSource,
                    g = e.audioProcessing;
                if (!Object(re.isEmpty)(n) && !Object(ne.is32Uint)(n) && !Object(re.isValidString)(n, 1, 255)) throw new Error("[String streamID] Length of the string: [1,255]. ASCII characters only. [Number streamID] The value range is Uint32");
                if (Object(re.checkValidBoolean)(i, "audio"), Object(re.checkValidBoolean)(a, "video"), Object(re.isEmpty)(r) || Object(re.checkValidBoolean)(r, "screen"), Object(re.isEmpty)(c) || Object(re.checkValidBoolean)(c, "screenAudio"), Object(re.isEmpty)(d) || Object(re.checkValidString)(d, "cameraId", 0, 255, !1), Object(re.isEmpty)(u) || Object(re.checkValidEnum)(u, "facingMode", ["user", "environment", "left", "right"]), Object(re.isEmpty)(l) || Object(re.checkValidString)(l, "microphoneId", 0, 255, !1), Object(re.isEmpty)(f) || Object(re.checkValidString)(f, "extensionId"), Object(re.isEmpty)(m) || Object(re.checkValidEnum)(m, "mediaSource", ["screen", "application", "window"]), Object(re.isEmpty)(p) || Object(re.checkValidBoolean)(p, "mirror"), !Object(re.isEmpty)(g)) {
                    var v = g.AGC,
                        h = g.AEC,
                        S = g.ANS;
                    Object(re.isEmpty)(v) || Object(re.checkValidBoolean)(v, "AGC"), Object(re.isEmpty)(h) || Object(re.checkValidBoolean)(h, "AEC"), Object(re.isEmpty)(S) || Object(re.checkValidBoolean)(S, "ANS")
                }
            ...
            getSupportedCodec: Je.getSupportedCodec,
            ChannelMediaRelayConfiguration: Ke.ChannelMediaRelayConfiguration,
            VERSION: r.VERSION,
            BUILD: r.BUILD,
            PROFILE_TABLE: en,
